import{u as _,e as C,r as d,j as e,s as j}from"./index-DsF0qlhL.js";import{g as T,f as h}from"./formatCurrency-CwSiFA8N.js";const B=["🍜","🚗","🛍️","🎮","💊","📱","✈️","📚","🏠","⚡","💰","🎓","🏋️","🎬","☕","🍔","🎁","💇","🐾","🌱"],$=["#6366f1","#3b82f6","#06b6d4","#10b981","#84cc16","#f59e0b","#f97316","#ef4444","#ec4899","#a855f7"];function K({onSuccess:m,onClose:p,editData:i}){const{user:w}=_(),g=C(),[y,N]=d.useState(!1),[r,u]=d.useState({name:"",budget_limit:"",color:"#6366f1",icon:"💰",...i}),l=async t=>{if(t.preventDefault(),!!r.name){N(!0);try{const s={user_id:w.id,name:r.name,budget_limit:parseFloat(r.budget_limit)||0,color:r.color,icon:r.icon};i!=null&&i.id?(await j.from("categories").update(s).eq("id",i.id),g("Kategori diperbarui","success")):(await j.from("categories").insert(s),g("Kategori ditambahkan","success")),m==null||m(),p==null||p()}catch(s){g(s.message,"error")}finally{N(!1)}}};return e.jsxs("form",{onSubmit:l,children:[e.jsxs("div",{className:"cf-preview",children:[e.jsx("div",{className:"cf-preview-icon",style:{background:`${r.color}18`,color:r.color},children:r.icon}),e.jsxs("div",{className:"cf-preview-info",children:[e.jsx("span",{className:"cf-preview-name",children:r.name||"Nama kategori"}),r.budget_limit&&e.jsxs("span",{className:"cf-preview-budget",children:["Budget: Rp ",Number(r.budget_limit).toLocaleString("id-ID"),"/bulan"]})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Nama Kategori"}),e.jsx("input",{className:"form-input",type:"text",placeholder:"Misal: Makan, Transportasi, Hiburan...",value:r.name,onChange:t=>u(s=>({...s,name:t.target.value})),required:!0,autoFocus:!0})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:["Budget per Bulan (Rp) ",e.jsx("span",{style:{color:"var(--text-muted)",textTransform:"none",letterSpacing:0,fontWeight:500},children:"(opsional)"})]}),e.jsx("input",{className:"form-input",type:"number",placeholder:"0 = tanpa batas",value:r.budget_limit,onChange:t=>u(s=>({...s,budget_limit:t.target.value})),min:"0"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Icon"}),e.jsx("div",{className:"cf-icon-grid",children:B.map(t=>e.jsx("button",{type:"button",className:`cf-icon-btn ${r.icon===t?"active":""}`,style:r.icon===t?{borderColor:r.color,background:`${r.color}15`}:{},onClick:()=>u(s=>({...s,icon:t})),children:t},t))})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Warna"}),e.jsx("div",{className:"cf-color-grid",children:$.map(t=>e.jsx("button",{type:"button",className:`cf-color-btn ${r.color===t?"active":""}`,style:{background:t},onClick:()=>u(s=>({...s,color:t})),title:t},t))})]}),e.jsxs("div",{className:"flex gap-8",style:{marginTop:20},children:[e.jsx("button",{type:"button",className:"btn btn-secondary",onClick:p,children:"Batal"}),e.jsx("button",{type:"submit",className:"btn btn-primary",style:{flex:1},disabled:y,children:y?"Menyimpan...":i!=null&&i.id?"Perbarui":"Buat Kategori"})]}),e.jsx("style",{children:`
        .cf-preview {
          display: flex;
          align-items: center;
          gap: 12px;
