import{u as W,e as R,r as m,j as e,s as v}from"./index-Bm1HTMFs.js";import{g as J,f as d}from"./formatCurrency-CwSiFA8N.js";import{C as L}from"./CurrencyInput-PtzIeZ_K.js";import{i as A}from"./mandatoryCategories-BLLVk51K.js";const Q=["🍜","🚗","🛍️","🎮","💊","📱","✈️","📚","🏠","⚡","💰","🎓","🏋️","🎬","☕","🍔","🎁","💇","🐾","🌱"],V=["#6366f1","#3b82f6","#06b6d4","#10b981","#84cc16","#f59e0b","#f97316","#ef4444","#ec4899","#a855f7"];function X({onSuccess:h,onClose:b,editData:c}){const{user:z}=W(),y=R(),[N,s]=m.useState(!1),[n,f]=m.useState({name:"",budget_limit:"",color:"#6366f1",icon:"💰",...c}),w=async r=>{if(r.preventDefault(),!!n.name){s(!0);try{const i={user_id:z.id,name:n.name,budget_limit:parseFloat(n.budget_limit)||0,color:n.color,icon:n.icon};c!=null&&c.id?(await v.from("categories").update(i).eq("id",c.id),y("Kategori diperbarui","success")):(await v.from("categories").insert(i),y("Kategori ditambahkan","success")),h==null||h(),b==null||b()}catch(i){y(i.message,"error")}finally{s(!1)}}};return e.jsxs("form",{onSubmit:w,children:[e.jsxs("div",{className:"cf-preview",children:[e.jsx("div",{className:"cf-preview-icon",style:{background:`${n.color}18`,color:n.color},children:n.icon}),e.jsxs("div",{className:"cf-preview-info",children:[e.jsx("span",{className:"cf-preview-name",children:n.name||"Nama kategori"}),n.budget_limit&&e.jsxs("span",{className:"cf-preview-budget",children:["Budget: Rp ",Number(n.budget_limit).toLocaleString("id-ID"),"/bulan"]})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Nama Kategori"}),e.jsx("input",{className:"form-input",type:"text",placeholder:"Misal: Makan, Transportasi, Hiburan...",value:n.name,onChange:r=>f(i=>({...i,name:r.target.value})),required:!0,autoFocus:!0})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:["Budget per Bulan ",e.jsx("span",{style:{color:"var(--text-muted)",textTransform:"none",letterSpacing:0,fontWeight:500},children:"(opsional, 0 = tanpa batas)"})]}),e.jsx(L,{value:n.budget_limit,onChange:r=>f(i=>({...i,budget_limit:r}))})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Icon"}),e.jsx("div",{className:"cf-icon-grid",children:Q.map(r=>e.jsx("button",{type:"button",className:`cf-icon-btn ${n.icon===r?"active":""}`,style:n.icon===r?{borderColor:n.color,background:`${n.color}15`}:{},onClick:()=>f(i=>({...i,icon:r})),children:r},r))})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Warna"}),e.jsx("div",{className:"cf-color-grid",children:V.map(r=>e.jsx("button",{type:"button",className:`cf-color-btn ${n.color===r?"active":""}`,style:{background:r},onClick:()=>f(i=>({...i,color:r})),title:r},r))})]}),e.jsxs("div",{className:"flex gap-8",style:{marginTop:20},children:[e.jsx("button",{type:"button",className:"btn btn-secondary",onClick:b,children:"Batal"}),e.jsx("button",{type:"submit",className:"btn btn-primary",style:{flex:1},disabled:N,children:N?"Menyimpan...":c!=null&&c.id?"Perbarui":"Buat Kategori"})]}),e.jsx("style",{children:`
      ...
      `})]})}const M=15;function te(){const{user:h}=W(),b=R(),[c,z]=m.useState([]),[y,N]=m.useState({}),[s,n]=m.useState(0),[f,w]=m.useState(!0),[r,i]=m.useState(!1),[k,P]=m.useState(null),[p,j]=m.useState(null),_=J();m.useEffect(()=>{C()},[]);const C=async()=>{var g;w(!0);const a=`${_}-01`,t=`${_}-31`,[o,l,B]=await Promise.all([v.from("categories").select("*").eq("user_id",h.id).order("name"),v.from("transactions").select("category_id, amount").eq("user_id",h.id).eq("type","expense").gte("date",a).lte("date",t),v.from("salaries").select("amount").eq("user_id",h.id).eq("month",_).maybeSingle()]),u={};(l.data||[]).forEach(x=>{x.category_id&&(u[x.category_id]=(u[x.category_id]||0)+Number(x.amount))}),z(o.data||[]),N(u),n(Number(((g=B.data)==null?void 0:g.amount)||0)),w(!1)},I=async a=>{confirm("Hapus kategori ini?")&&(await v.from("categories").delete().eq("id",a),b("Kategori dihapus","success"),C())},$=a=>{const t=String(Math.round(a.budget_limit||0)),o=s>0&&a.budget_limit>0?(a.budget_limit/s*100).toFixed(1):"";j({id:a.id,nominal:t,pct:o})},O=a=>{const t=parseFloat(a)||0,o=s>0&&t>0?(t/s*100).toFixed(1):"";j(l=>({...l,nominal:a,pct:o}))},E=a=>{const t=parseFloat(a)||0,o=s>0&&t>0?String(Math.round(t/100*s)):"";j(l=>({...l,pct:a,nominal:o}))},H=async()=>{const a=parseFloat(p.nominal)||0;await v.from("categories").update({budget_limit:a}).eq("id",p.id),b("Budget disimpan","success"),j(null),C()},K=c.filter(a=>A(a)),q=c.filter(a=>!A(a)),U=c.reduce((a,t)=>a+Number(t.budget_limit||0),0),G=Object.values(y).reduce((a,t)=>a+t,0),T=(a,t)=>{const o=y[a.id]||0,l=Number(a.budget_limit||0),B=l>0?Math.min(o/l*100,100):0,u=l>0?o/l*100:0,g=u>100,x=!g&&u>=100,F=!g&&u>=80&&u<100,Y=g?"var(--danger)":x?"var(--success)":F?"var(--warning)":a.color,S=s>0&&l>0?(l/s*100).toFixed(0):null;return t?e.jsxs("div",{className:"cat-card cat-mandatory",style:{"--cat-color":a.color},children:[e.jsxs("div",{className:"cat-card-top",children:[e.jsxs("div",{className:"cat-card-left",children:[e.jsx("span",{className:"cat-icon",style:{background:`${a.color}20`,color:a.color},children:a.icon}),e.jsxs("div",{children:[e.jsx("span",{className:"cat-name",children:a.name}),e.jsx("span",{className:"cat-mandatory-badge",children:"Wajib · langsung dipotong"})]})]}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>$(a),style:{fontSize:"0.72rem"},children:"Ubah"})]}),e.jsxs("div",{className:"mand-budget-row",children:[e.jsxs("div",{children:[e.jsx("span",{className:"mand-label",children:"Budget per bulan"}),e.jsx("span",{className:"mand-val tabular",children:l>0?d(l):"—"})]}),S&&e.jsxs("span",{className:"mand-pct-chip",children:[S,"% gaji"]})]})]},a.id):e.jsxs("div",{className:"cat-card",style:{"--cat-color":a.color},children:[e.jsxs("div",{className:"cat-card-top",children:[e.jsxs("div",{className:"cat-card-left",children:[e.jsx("span",{className:"cat-icon",style:{background:`${a.color}20`,color:a.color},children:a.icon}),e.jsx("span",{className:"cat-name",children:a.name})]}),e.jsxs("div",{className:"cat-card-actions",children:[e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>{P(a),i(!0)},children:"✎"}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>$(a),style:{fontSize:"0.72rem",whiteSpace:"nowrap"},children:l>0?"Set":"+ Budget"}),e.jsx("button",{className:"btn btn-ghost btn-sm",style:{color:"var(--danger)"},onClick:()=>I(a.id),children:"✕"})]})]}),l>0?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cat-amounts",children:[e.jsx("span",{className:"cat-spent tabular",style:{color:g?"var(--danger)":"var(--text-primary)"},children:d(o)}),e.jsxs("div",{style:{textAlign:"right"},children:[e.jsxs("span",{className:"cat-budget tabular",children:["/ ",d(l)]}),S&&e.jsxs("span",{className:"cat-pct-label",children:[S,"% gaji"]})]})]}),e.jsx("div",{className:"progress-bar",style:{height:6},children:e.jsx("div",{className:"progress-fill",style:{width:`${B}%`,background:Y}})}),e.jsxs("div",{className:"cat-status-row",children:[g&&e.jsxs("span",{className:"badge badge-danger",style:{fontSize:"0.6rem"},children:["Over ",d(o-l)]}),x&&e.jsx("span",{className:"badge badge-success",style:{fontSize:"0.6rem"},children:"Penuh"}),F&&e.jsx("span",{className:"badge badge-warning",style:{fontSize:"0.6rem"},children:"Hampir"}),!g&&!x&&!F&&e.jsxs("span",{className:"cat-sisa",children:["Sisa ",d(l-o)]})]})]}):e.jsxs("div",{className:"cat-no-budget",children:[e.jsx("span",{children:"Belum ada budget"}),s>0&&e.jsxs("span",{className:"cat-no-budget-hint",children:["Default: ",d(Math.round(s*M/100))," (",M,"%)"]})]})]},a.id)};return e.jsxs("div",{className:"animate-in",children:[e.jsxs("div",{className:"flex-between mb-24",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"page-title",children:"Kategori"}),e.jsxs("p",{className:"page-subtitle",style:{margin:0},children:[d(G)," dari ",d(U)," budget bulan ini"]})]}),e.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>{P(null),i(!0)},children:"+ Kategori"})]}),e.jsxs("div",{className:"cat-section mb-24",children:[e.jsx("div",{className:"cat-section-head",children:e.jsxs("div",{children:[e.jsx("span",{className:"cat-section-title",children:"Pengeluaran Wajib"}),e.jsx("span",{className:"cat-section-sub",children:s>0?`${d(K.reduce((a,t)=>a+Number(t.budget_limit||0),0))} dari gaji ${d(s)} — langsung dipotong`:"Atur gaji di Dashboard untuk lihat persentase"})]})}),f?e.jsx("div",{className:"cat-grid",children:[...Array(3)].map((a,t)=>e.jsx("div",{className:"skeleton",style:{height:140}},t))}):e.jsx("div",{className:"cat-grid",children:K.map(a=>T(a,!0))})]}),e.jsxs("div",{className:"cat-section",children:[e.jsx("div",{className:"cat-section-head",children:e.jsx("span",{className:"cat-section-title",children:"Kategori Lainnya"})}),f?e.jsx("div",{className:"cat-grid",children:[...Array(2)].map((a,t)=>e.jsx("div",{className:"skeleton",style:{height:140}},t))}):q.length===0?e.jsx("div",{className:"card",children:e.jsxs("div",{className:"empty-state",style:{padding:"20px 0"},children:[e.jsx("div",{className:"empty-state-icon",children:"◈"}),e.jsx("strong",{children:"Belum ada kategori lain"}),e.jsx("p",{children:"Tambah kategori pengeluaran sesuai kebutuhanmu"})]})}):e.jsx("div",{className:"cat-grid",children:q.map(a=>T(a,!1))})]}),r&&e.jsx("div",{className:"modal-overlay",onClick:()=>i(!1),children:e.jsxs("div",{className:"modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h2",{className:"modal-title",children:k!=null&&k.id?"Edit Kategori":"Kategori Baru"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>i(!1),children:"✕"})]}),e.jsx(X,{editData:k,onSuccess:()=>{C(),i(!1)},onClose:()=>i(!1)})]})}),p&&(()=>{const a=c.find(t=>t.id===p.id);return e.jsx("div",{className:"modal-overlay",onClick:()=>j(null),children:e.jsxs("div",{className:"modal",style:{maxWidth:380},onClick:t=>t.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"modal-title",children:["Budget — ",a==null?void 0:a.name]}),s>0&&e.jsxs("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:["Gaji: ",d(s)]})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>j(null),children:"✕"})]}),s>0&&e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Persentase dari gaji"}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[e.jsxs("div",{style:{position:"relative",flex:1},children:[e.jsx("input",{className:"form-input",type:"number",placeholder:String(M),value:p.pct,onChange:t=>E(t.target.value),min:"0",max:"100",step:"0.5",style:{paddingRight:36}}),e.jsx("span",{style:{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",color:"var(--text-muted)",fontWeight:700,fontSize:"0.85rem"},children:"%"})]}),p.pct&&s>0&&e.jsxs("span",{style:{fontSize:"0.78rem",color:"var(--text-secondary)",fontWeight:600,whiteSpace:"nowrap"},children:["= ",d(Math.round(parseFloat(p.pct)/100*s))]})]}),!p.pct&&e.jsx("div",{style:{display:"flex",gap:6,marginTop:6,flexWrap:"wrap"},children:[10,15,20,25].map(t=>e.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>E(String(t)),children:[t,"%"]},t))})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Atau nominal langsung"}),e.jsx(L,{value:p.nominal,onChange:O,autoFocus:!s})]}),e.jsxs("div",{className:"flex gap-8 mt-16",children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>j(null),children:"Batal"}),e.jsx("button",{className:"btn btn-primary",style:{flex:1},onClick:H,children:"Simpan"})]})]})})})(),e.jsx("style",{children:`
        .cat-section { }
