import{u as G,e as Y,r as d,s as h,j as e}from"./index-CyJhTPzR.js";import{g as J,u as Q,f as l}from"./useAutoRefresh-DHUm4R5n.js";import{i as $,C as V}from"./mandatoryCategories-_4RPxRy2.js";import{C as X}from"./ConfirmModal-TjabUTrL.js";import{C as Z}from"./CurrencyInput-91oGiCJZ.js";const S=15;function ie(){const{user:x}=G(),_=Y(),[y,K]=d.useState([]),[z,R]=d.useState({}),[n,T]=d.useState(0),[B,F]=d.useState(!0),[W,g]=d.useState(!1),[v,M]=d.useState(null),[c,m]=d.useState(null),[w,k]=d.useState(null),b=J();d.useEffect(()=>{f()},[]),Q(f);const f=async()=>{var N;F(!0);const a=`${b}-01`,t=`${b}-31`,[r,s,C,u]=await Promise.all([h.from("categories").select("*").eq("user_id",x.id).order("name"),h.from("transactions").select("category_id, amount").eq("user_id",x.id).eq("type","expense").gte("date",a).lte("date",t),h.from("salaries").select("amount").eq("user_id",x.id).eq("month",b).maybeSingle(),h.from("category_budgets").select("*").eq("user_id",x.id).eq("month",b)]),o={};(u.data||[]).forEach(i=>{o[i.category_id]=Number(i.budget_limit)});const p={};(s.data||[]).forEach(i=>{i.category_id&&(p[i.category_id]=(p[i.category_id]||0)+Number(i.amount))});const j=(r.data||[]).map(i=>({...i,budget_limit:o[i.id]!==void 0?o[i.id]:0}));K(j),R(p),T(Number(((N=C.data)==null?void 0:N.amount)||0)),F(!1)},H=async()=>{await h.from("categories").delete().eq("id",w.id),_("Kategori dihapus","success"),k(null),f()},E=a=>{const t=String(Math.round(a.budget_limit||0)),r=n>0&&a.budget_limit>0?(a.budget_limit/n*100).toFixed(1):"";m({id:a.id,nominal:t,pct:r})},L=a=>{const t=parseFloat(a)||0,r=n>0&&t>0?(t/n*100).toFixed(1):"";m(s=>({...s,nominal:a,pct:r}))},P=a=>{const t=parseFloat(a)||0,r=n>0&&t>0?String(Math.round(t/100*n)):"";m(s=>({...s,pct:a,nominal:r}))},I=async()=>{const a=parseFloat(c.nominal)||0;await h.from("category_budgets").upsert({user_id:x.id,category_id:c.id,month:b,budget_limit:a},{onConflict:"category_id,month"}),_("Budget bulan ini disimpan","success"),m(null),f()},A=y.filter(a=>$(a)),q=y.filter(a=>!$(a)),O=y.reduce((a,t)=>a+Number(t.budget_limit||0),0),U=Object.values(z).reduce((a,t)=>a+t,0),D=(a,t)=>{const r=z[a.id]||0,s=Number(a.budget_limit||0),C=s>0?Math.min(r/s*100,100):0,u=s>0?r/s*100:0,o=u>100,p=!o&&u>=100,j=!o&&u>=80&&u<100,N=o?"var(--danger)":p?"var(--success)":j?"var(--warning)":a.color,i=n>0&&s>0?(s/n*100).toFixed(0):null;return t?e.jsxs("div",{className:"cat-card cat-mandatory",style:{"--cat-color":a.color},children:[e.jsxs("div",{className:"cat-card-top",children:[e.jsxs("div",{className:"cat-card-left",children:[e.jsx("span",{className:"cat-icon",style:{background:`${a.color}20`,color:a.color},children:a.icon}),e.jsxs("div",{children:[e.jsx("span",{className:"cat-name",children:a.name}),e.jsx("span",{className:"cat-mandatory-badge",children:"Wajib · langsung dipotong"})]})]}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>E(a),style:{fontSize:"0.72rem"},children:"Ubah"})]}),e.jsxs("div",{className:"mand-budget-row",children:[e.jsxs("div",{children:[e.jsx("span",{className:"mand-label",children:"Budget per bulan"}),e.jsx("span",{className:"mand-val tabular",children:s>0?l(s):"—"})]}),i&&e.jsxs("span",{className:"mand-pct-chip",children:[i,"% gaji"]})]})]},a.id):e.jsxs("div",{className:"cat-card",style:{"--cat-color":a.color},children:[e.jsxs("div",{className:"cat-card-top",children:[e.jsxs("div",{className:"cat-card-left",children:[e.jsx("span",{className:"cat-icon",style:{background:`${a.color}20`,color:a.color},children:a.icon}),e.jsx("span",{className:"cat-name",children:a.name})]}),e.jsxs("div",{className:"cat-card-actions",children:[e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>{M(a),g(!0)},children:"✎"}),e.jsx("button",{className:"btn btn-ghost btn-sm",onClick:()=>E(a),style:{fontSize:"0.72rem",whiteSpace:"nowrap"},children:s>0?"Set":"+ Budget"}),e.jsx("button",{className:"btn btn-ghost btn-sm",style:{color:"var(--danger)"},onClick:()=>k({id:a.id,name:a.name}),children:"✕"})]})]}),s>0?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cat-amounts",children:[e.jsx("span",{className:"cat-spent tabular",style:{color:o?"var(--danger)":"var(--text-primary)"},children:l(r)}),e.jsxs("div",{style:{textAlign:"right"},children:[e.jsxs("span",{className:"cat-budget tabular",children:["/ ",l(s)]}),i&&e.jsxs("span",{className:"cat-pct-label",children:[i,"% gaji"]})]})]}),e.jsx("div",{className:"progress-bar",style:{height:6},children:e.jsx("div",{className:"progress-fill",style:{width:`${C}%`,background:N}})}),e.jsxs("div",{className:"cat-status-row",children:[o&&e.jsxs("span",{className:"badge badge-danger",style:{fontSize:"0.6rem"},children:["Over ",l(r-s)]}),p&&e.jsx("span",{className:"badge badge-success",style:{fontSize:"0.6rem"},children:"Penuh"}),j&&e.jsx("span",{className:"badge badge-warning",style:{fontSize:"0.6rem"},children:"Hampir"}),!o&&!p&&!j&&e.jsxs("span",{className:"cat-sisa",children:["Sisa ",l(s-r)]})]})]}):e.jsxs("div",{className:"cat-no-budget",children:[e.jsx("span",{children:"Belum ada budget"}),n>0&&e.jsxs("span",{className:"cat-no-budget-hint",children:["Default: ",l(Math.round(n*S/100))," (",S,"%)"]})]})]},a.id)};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"animate-in",children:[e.jsxs("div",{className:"flex-between mb-24",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"page-title",children:"Kategori"}),e.jsxs("p",{className:"page-subtitle",style:{margin:0},children:[l(U)," dari ",l(O)," budget bulan ini"]})]}),e.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>{M(null),g(!0)},children:"+ Kategori"})]}),e.jsxs("div",{className:"cat-section mb-24",children:[e.jsx("div",{className:"cat-section-head",children:e.jsxs("div",{children:[e.jsx("span",{className:"cat-section-title",children:"Pengeluaran Wajib"}),e.jsx("span",{className:"cat-section-sub",children:n>0?`${l(A.reduce((a,t)=>a+Number(t.budget_limit||0),0))} dari gaji ${l(n)} — langsung dipotong`:"Atur gaji di Dashboard untuk lihat persentase"})]})}),B?e.jsx("div",{className:"cat-grid",children:[...Array(3)].map((a,t)=>e.jsx("div",{className:"skeleton",style:{height:140}},t))}):e.jsx("div",{className:"cat-grid",children:A.map(a=>D(a,!0))})]}),e.jsxs("div",{className:"cat-section",children:[e.jsx("div",{className:"cat-section-head",children:e.jsx("span",{className:"cat-section-title",children:"Kategori Lainnya"})}),B?e.jsx("div",{className:"cat-grid",children:[...Array(2)].map((a,t)=>e.jsx("div",{className:"skeleton",style:{height:140}},t))}):q.length===0?e.jsx("div",{className:"card",children:e.jsxs("div",{className:"empty-state",style:{padding:"20px 0"},children:[e.jsx("div",{className:"empty-state-icon",children:"◈"}),e.jsx("strong",{children:"Belum ada kategori lain"}),e.jsx("p",{children:"Tambah kategori pengeluaran sesuai kebutuhanmu"})]})}):e.jsx("div",{className:"cat-grid",children:q.map(a=>D(a,!1))})]}),e.jsx("style",{children:`
        .cat-section { }
