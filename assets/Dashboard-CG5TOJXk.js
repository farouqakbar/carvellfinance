import{u as Z,e as ee,d as ae,r as h,s as j,j as e,L as z}from"./index-CGMV6nB_.js";import{g as L,a as C,f as n}from"./formatCurrency-CwSiFA8N.js";import{T as se}from"./TransactionForm-DV546nlw.js";import{C as te}from"./CurrencyInput-BYTLIAzb.js";function re(d){const[b,v]=d.split("-").map(Number),m=new Date(b,v-2,1);return`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}`}function ne(d){const[b,v]=d.split("-").map(Number),m=new Date(b,v,1);return`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}`}function de(){const{user:d}=Z(),b=ee(),[v,m]=ae(),[l,R]=h.useState(()=>v.get("month")||L()),[s,q]=h.useState({salary:0,totalExpense:0,totalIncome:0,categories:[],transactions:[],savings:[],categorySpend:[]}),[f,T]=h.useState(!0),[G,x]=h.useState(!1),[$,M]=h.useState(""),[H,g]=h.useState(!1);h.useEffect(()=>{S()},[l]);const D=a=>{R(a),m({month:a})},S=async()=>{var a;T(!0);try{const r=`${l}-01`,o=`${l}-31`,[c,u,W,Y]=await Promise.all([j.from("salaries").select("*").eq("user_id",d.id).eq("month",l).maybeSingle(),j.from("transactions").select("*, categories(name, color, icon)").eq("user_id",d.id).gte("date",r).lte("date",o).order("date",{ascending:!1}),j.from("categories").select("*").eq("user_id",d.id).order("name"),j.from("savings").select("*").eq("user_id",d.id)]),k=u.data||[],U=W.data||[],J=k.filter(t=>t.type==="expense").reduce((t,i)=>t+Number(i.amount),0),Q=k.filter(t=>t.type==="income").reduce((t,i)=>t+Number(i.amount),0),y={};k.filter(t=>t.type==="expense"&&t.categories).forEach(t=>{const i=t.categories.name;y[i]||(y[i]={name:i,amount:0,color:t.categories.color,icon:t.categories.icon}),y[i].amount+=Number(t.amount)});const V=U.map(t=>{var A;const i=((A=y[t.name])==null?void 0:A.amount)||0,X=t.budget_limit>0?i/t.budget_limit*100:null;return{...t,spent:i,pct:X,overBudget:t.budget_limit>0&&i>t.budget_limit}}).sort((t,i)=>t.overBudget&&!i.overBudget?-1:!t.overBudget&&i.overBudget?1:(i.pct||0)-(t.pct||0));q({salary:((a=c.data)==null?void 0:a.amount)||0,totalExpense:J,totalIncome:Q,categories:V,transactions:k.slice(0,6),savings:Y.data||[],categorySpend:Object.values(y).sort((t,i)=>i.amount-t.amount)})}finally{T(!1)}},K=async()=>{const a=parseFloat($);a&&(await j.from("salaries").upsert({user_id:d.id,month:l,amount:a},{onConflict:"user_id,month"}),b("Gaji disimpan","success"),x(!1),M(""),S())},E=s.categories.filter(a=>a.budget_limit>0).reduce((a,r)=>a+r.budget_limit,0),w=s.salary+s.totalIncome-s.totalExpense,N=s.salary>0?s.totalExpense/s.salary*100:0,O=l===L(),F=s.categories.filter(a=>a.overBudget),I=N>90?"var(--danger)":N>70?"var(--warning)":"var(--accent)",p=s.savings.reduce((a,r)=>a+Number(r.target_amount),0),_=s.salary>0?s.salary-p:0,P=_-s.totalExpense,B=s.salary>0&&p>0&&s.totalExpense>_;return e.jsxs("div",{className:"animate-in",children:[e.jsxs("div",{className:"dash-header",children:[e.jsxs("div",{className:"month-nav-group",children:[e.jsx("button",{className:"month-btn",onClick:()=>D(re(l)),children:"‹"}),e.jsx("span",{className:"month-label-text",children:C(l)}),e.jsx("button",{className:"month-btn",onClick:()=>D(ne(l)),disabled:O,children:"›"})]}),e.jsxs("div",{className:"flex gap-8",children:[e.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>x(!0),children:"Atur Gaji"}),e.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>g(!0),children:"+ Transaksi"})]})]}),F.length>0&&e.jsxs("div",{className:"alert-banner",children:[e.jsx("span",{children:"⚠"}),e.jsxs("span",{children:[e.jsx("strong",{children:"Overbudget"})," — ",F.map(a=>`${a.icon} ${a.name}`).join(", ")]})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16},children:[e.jsx("div",{className:"hero-card",children:f?e.jsx("div",{className:"skeleton",style:{height:88,borderRadius:8}}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"hero-top",children:[e.jsxs("div",{className:"hero-left",children:[e.jsxs("span",{className:"hero-eyebrow",children:["Saldo Bersih ",C(l)]}),e.jsxs("div",{className:`hero-balance ${w<0?"neg":""}`,children:[w<0&&e.jsx("span",{className:"hero-neg-sign",children:"-"}),n(Math.abs(w))]})]}),e.jsxs("div",{className:"hero-right",children:[s.salary>0&&e.jsxs("div",{className:"hero-chip",children:[e.jsx("span",{className:"hero-chip-label",children:"Gaji"}),e.jsx("span",{className:"hero-chip-val tabular",children:n(s.salary)})]}),s.savings.length>0&&e.jsxs("div",{className:"hero-chip",children:[e.jsx("span",{className:"hero-chip-label",children:"Total Tabungan"}),e.jsx("span",{className:"hero-chip-val tabular",style:{color:"var(--success)"},children:n(s.savings.reduce((a,r)=>a+Number(r.current_amount),0))})]})]})]}),s.salary>0?e.jsxs("div",{className:"hero-bar-section",children:[e.jsx("div",{className:"hero-bar-track",children:e.jsx("div",{className:"hero-bar-fill",style:{width:`${Math.min(N,100)}%`,background:I}})}),e.jsxs("div",{className:"hero-bar-labels",children:[e.jsxs("span",{children:[n(s.totalExpense)," dipakai"]}),e.jsxs("span",{style:{color:I,fontWeight:700},children:[N.toFixed(0),"%"]})]})]}):e.jsxs("div",{className:"hero-no-salary",children:[e.jsx("button",{className:"salary-cta",onClick:()=>x(!0),children:"+ Atur gaji bulan ini"}),e.jsx("span",{className:"salary-cta-hint",children:"untuk menghitung saldo bersih"})]})]})}),e.jsxs("div",{className:"stats-strip",children:[e.jsxs("div",{className:"stat-col",children:[e.jsx("span",{className:"stat-col-label",children:"Pemasukan"}),e.jsxs("span",{className:"stat-col-val tabular",style:{color:"var(--success)"},children:["+",n(s.totalIncome)]})]}),e.jsxs("div",{className:"stat-col",children:[e.jsx("span",{className:"stat-col-label",children:"Pengeluaran"}),e.jsxs("span",{className:"stat-col-val tabular",style:{color:B?"var(--danger)":"var(--text-primary)"},children:["-",n(s.totalExpense)]}),s.salary>0&&p>0&&e.jsxs("span",{className:"stat-col-sub",style:{color:B?"var(--danger)":"var(--text-muted)"},children:[B?"⚠ ":"","Batas ",n(_)]})]}),e.jsxs("div",{className:"stat-col",children:[e.jsx("span",{className:"stat-col-label",children:s.salary>0&&p>0?"Sisa belanja":"Bisa ditabung"}),e.jsx("span",{className:"stat-col-val tabular",style:{color:P>=0?"var(--accent)":"var(--danger)"},children:s.salary>0&&p>0?n(Math.max(0,P)):n(Math.max(0,w))}),s.salary>0&&p>0&&e.jsxs("span",{className:"stat-col-sub",children:["Tabungan ",n(p),"/bln"]})]})]}),e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"sect-head",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"sect-title",children:"Budget Kategori"}),E>0&&e.jsxs("p",{className:"sect-sub",children:[n(s.totalExpense)," dari ",n(E)]})]}),e.jsx(z,{to:"/categories",className:"pill-link",children:"Kelola"})]}),f?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:[...Array(3)].map((a,r)=>e.jsx("div",{className:"skeleton",style:{height:44}},r))}):s.categories.filter(a=>a.budget_limit>0).length===0?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:"◈"}),e.jsx("span",{children:"Belum ada budget kategori. "}),e.jsx(z,{to:"/categories",className:"empty-hint-link",children:"Buat sekarang →"})]}):e.jsxs("div",{className:"budget-rows",children:[s.categories.filter(a=>a.budget_limit>0).map(a=>{const r=Math.min(a.spent/a.budget_limit*100,100),o=a.overBudget?"var(--danger)":r>=80?"var(--warning)":a.color;return e.jsxs("div",{className:"brow",children:[e.jsxs("div",{className:"brow-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${a.color}18`,color:a.color},children:a.icon}),e.jsx("span",{className:"brow-name",children:a.name}),a.overBudget&&e.jsx("span",{className:"badge badge-danger",style:{fontSize:"0.58rem",padding:"1px 6px"},children:"Over"}),!a.overBudget&&r>=80&&e.jsx("span",{className:"badge badge-warning",style:{fontSize:"0.58rem",padding:"1px 6px"},children:"Hampir"})]}),e.jsx("div",{className:"brow-bar-wrap",children:e.jsx("div",{className:"brow-bar",children:e.jsx("div",{className:"brow-bar-fill",style:{width:`${r}%`,background:o}})})}),e.jsxs("div",{className:"brow-right",children:[e.jsx("span",{className:"brow-spent tabular",style:{color:a.overBudget?"var(--danger)":"var(--text-primary)"},children:n(a.spent)}),e.jsxs("span",{className:"brow-limit tabular",children:["/",n(a.budget_limit)]})]}),e.jsxs("span",{className:"brow-pct",style:{color:o},children:[r.toFixed(0),"%"]})]},a.id)}),s.categories.filter(a=>a.budget_limit===0&&a.spent>0).map(a=>e.jsxs("div",{className:"brow no-limit",children:[e.jsxs("div",{className:"brow-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${a.color}18`,color:a.color},children:a.icon}),e.jsx("span",{className:"brow-name",children:a.name}),e.jsx("span",{className:"brow-no-limit-tag",children:"no limit"})]}),e.jsx("div",{className:"brow-bar-wrap"}),e.jsx("span",{className:"brow-spent tabular",children:n(a.spent)})]},a.id))]})]}),(f||s.savings.length>0)&&e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"sect-head",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"sect-title",children:"Tabungan"}),s.savings.length>0&&e.jsxs("p",{className:"sect-sub",children:[n(s.savings.reduce((a,r)=>a+Number(r.current_amount),0))," terkumpul"]})]}),e.jsx(z,{to:"/savings",className:"pill-link",children:"Kelola"})]}),f?e.jsx("div",{className:"savings-grid",children:[...Array(2)].map((a,r)=>e.jsx("div",{className:"skeleton",style:{height:68}},r))}):e.jsx("div",{className:"savings-grid",children:s.savings.map(a=>{const r=a.target_amount>0?Math.min(a.current_amount/a.target_amount*100,100):0,o=r>=100,c=a.deadline?Math.ceil((new Date(a.deadline)-new Date)/864e5):null,u=c!==null&&c<30&&!o;return e.jsxs("div",{className:`sv-chip ${o?"sv-done":u?"sv-urgent":""}`,children:[e.jsxs("div",{className:"sv-chip-top",children:[e.jsx("span",{className:"sv-chip-name",children:a.name}),e.jsx("span",{className:"sv-chip-pct",style:{color:o?"var(--success)":u?"var(--warning)":"var(--text-muted)"},children:o?"✓":`${r.toFixed(0)}%`})]}),e.jsxs("div",{className:"sv-chip-amounts",children:[e.jsx("span",{className:"sv-chip-cur tabular",children:n(a.current_amount)}),e.jsxs("span",{className:"sv-chip-tgt tabular",children:["/ ",n(a.target_amount)]})]}),e.jsx("div",{className:"sv-chip-bar",children:e.jsx("div",{className:"sv-chip-fill",style:{width:`${r}%`,background:o?"var(--success)":u?"var(--warning)":"linear-gradient(90deg, var(--accent), var(--info))"}})}),u&&c!==null&&e.jsx("span",{className:"sv-chip-deadline",children:c>0?`${c} hari lagi`:"Deadline lewat"})]},a.id)})})]}),e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"sect-head",children:[e.jsx("h3",{className:"sect-title",children:"Transaksi Terakhir"}),e.jsx(z,{to:"/transactions",className:"pill-link",children:"Lihat semua"})]}),f?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8,marginTop:12},children:[...Array(4)].map((a,r)=>e.jsx("div",{className:"skeleton",style:{height:42}},r))}):s.transactions.length===0?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:"↕"}),e.jsx("span",{children:"Belum ada transaksi bulan ini. "}),e.jsx("button",{className:"empty-hint-link",onClick:()=>g(!0),children:"Tambah sekarang →"})]}):e.jsx("div",{className:"tx-list",children:s.transactions.map(a=>{var r,o,c;return e.jsxs("div",{className:"tx-row",children:[e.jsx("div",{className:"tx-icon",style:{background:(r=a.categories)!=null&&r.color?`${a.categories.color}18`:"var(--bg-input)"},children:((o=a.categories)==null?void 0:o.icon)||(a.type==="income"?"↑":"↓")}),e.jsxs("div",{className:"tx-meta",children:[e.jsx("span",{className:"tx-desc",children:a.description||((c=a.categories)==null?void 0:c.name)||"Transaksi"}),e.jsx("span",{className:"tx-date",children:new Date(a.date).toLocaleDateString("id-ID",{day:"numeric",month:"short"})})]}),e.jsxs("span",{className:`tx-amount tabular ${a.type==="income"?"inc":"exp"}`,children:[a.type==="income"?"+":"−",n(a.amount)]})]},a.id)})})]})]}),G&&e.jsx("div",{className:"modal-overlay",onClick:()=>x(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:380},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("h2",{className:"modal-title",children:["Gaji ",C(l)]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>x(!1),children:"✕"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Gaji Bulan Ini"}),e.jsx(te,{value:$,onChange:a=>M(a),autoFocus:!0})]}),e.jsxs("div",{className:"flex gap-8",children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>x(!1),children:"Batal"}),e.jsx("button",{className:"btn btn-primary",style:{flex:1},onClick:K,children:"Simpan"})]})]})}),H&&e.jsx("div",{className:"modal-overlay",onClick:()=>g(!1),children:e.jsxs("div",{className:"modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h2",{className:"modal-title",children:"Tambah Transaksi"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>g(!1),children:"✕"})]}),e.jsx(se,{onSuccess:()=>{S(),g(!1)},onClose:()=>g(!1)})]})}),e.jsx("style",{children:`
        /* ── Header ───────────────────────────── */
        .dash-header {
