import{G as se,J as re,M as ne,K as oe,E as n,x as $,D as e,L as ie,A as le,n as ce,z as de,F as h,w as f,l as me,d as pe,b as q,j as xe,r as ue,t as ge}from"./index-CQKwVZRO.js";import{T as he}from"./TransactionForm-Cya7fdrb.js";import{C as fe}from"./ConfirmModal-Cm6hxZjU.js";function be(i){const[u,g]=i.split("-").map(Number),p=new Date(u,g-2,1);return`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,"0")}`}function ye(i){const[u,g]=i.split("-").map(Number),p=new Date(u,g,1);return`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,"0")}`}function ke(){const{user:i}=se(),{setHeader:u}=re(),g=ne(),[p,B]=oe(),[l,I]=n.useState(()=>p.get("month")||$()),[x,R]=n.useState([]),[b,H]=n.useState([]),[je,G]=n.useState(0),[K,D]=n.useState(!0),[O,y]=n.useState(!1),[v,M]=n.useState(null),[z,N]=n.useState(null),[o,w]=n.useState({category:"",type:"",search:""}),T=l===$(),E=!!i.recording_start_month&&l<=i.recording_start_month,L=a=>{I(a),B({month:a})};n.useEffect(()=>{k()},[l]),n.useEffect(()=>(u(e.jsxs(e.Fragment,{children:[e.jsxs(ie,{to:`/dashboard?month=${l}`,className:"topbar-back-btn",children:["‹ ",e.jsx("span",{className:"back-label",children:"Dashboard"})]}),e.jsxs("div",{className:"month-nav-group",children:[e.jsx("button",{className:"month-btn",onClick:()=>L(be(l)),disabled:E,children:"‹"}),e.jsx("span",{className:"month-label-text",children:le(l)}),e.jsx("button",{className:"month-btn",onClick:()=>L(ye(l)),disabled:T,children:"›"})]}),e.jsx("div",{className:"topbar-actions",children:e.jsxs("button",{className:"btn btn-primary btn-sm",style:{height:34,gap:5},onClick:()=>{M(null),y(!0)},children:[e.jsx(ce,{size:13})," Transaksi"]})})]})),()=>u(null)),[l,T,E]);const k=async()=>{D(!0);const a=`${l}-01`,t=de(l),s=i.recording_start_month;let r=h.from("transactions").select("amount, type").eq("user_id",i.id).lte("date",t);s&&(r=r.gte("date",`${s}-01`));let d=h.from("category_budgets").select("budget_limit, category_id").eq("user_id",i.id).lte("month",l);s&&(d=d.gte("month",s));const[_,S,X,V,Z]=await Promise.all([h.from("transactions").select("*, categories(name, color, icon)").eq("user_id",i.id).gte("date",a).lte("date",t).order("date",{ascending:!1}).order("created_at",{ascending:!1}),h.from("categories").select("*").eq("user_id",i.id).is("month",null).order("name"),r,d,h.from("category_budgets").select("budget_limit, category_id").eq("user_id",i.id).eq("month",l)]),P=S.data||[],C={};(Z.data||[]).forEach(c=>{C[c.category_id]=Number(c.budget_limit)});const ee=P.map(c=>({...c,budget_limit:C[c.id]!==void 0?C[c.id]:c.budget_limit||0})),te=(X.data||[]).reduce((c,m)=>c+(m.type==="income"?Number(m.amount):-Number(m.amount)),0)+(i.saldo_awal||0),ae=(V.data||[]).filter(c=>P.find(m=>m.id===c.category_id&&m.is_mandatory)).reduce((c,m)=>c+Number(m.budget_limit),0);R(_.data||[]),H(ee),G(te-ae),D(!1)},W=async()=>{const{error:a}=await h.from("transactions").delete().eq("id",z);if(a){g(a.message,"error");return}g("Transaksi dihapus","success"),N(null),k()},j=n.useMemo(()=>x.filter(a=>{var t,s,r;if(o.category&&a.category_id!==o.category||o.type&&a.type!==o.type)return!1;if(o.search){const d=o.search.toLowerCase(),_=(t=a.description)==null?void 0:t.toLowerCase().includes(d),S=(r=(s=a.categories)==null?void 0:s.name)==null?void 0:r.toLowerCase().includes(d);if(!_&&!S)return!1}return!0}),[x,o]),Q=n.useMemo(()=>{const a={};return j.forEach(t=>{a[t.date]||(a[t.date]=[]),a[t.date].push(t)}),Object.entries(a).sort(([t],[s])=>s.localeCompare(t))},[j]);n.useMemo(()=>j.reduce((a,t)=>(t.type==="expense"?a.expense+=Number(t.amount):a.income+=Number(t.amount),a),{expense:0,income:0}),[j]);const A=n.useMemo(()=>x.reduce((a,t)=>(t.type==="expense"?a.expense+=Number(t.amount):a.income+=Number(t.amount),a),{expense:0,income:0}),[x]),U=n.useMemo(()=>{const a=b.find(t=>t.name==="Pemasukan Bulanan");return x.filter(t=>t.type==="income"&&t.category_id===(a==null?void 0:a.id)).reduce((t,s)=>t+Number(s.amount),0)},[x,b]),F=o.category||o.type||o.search,Y=a=>{const t=new Date(a+"T00:00:00"),s=new Date,r=new Date(s);return r.setDate(s.getDate()-1),t.toDateString()===s.toDateString()?"Hari ini":t.toDateString()===r.toDateString()?"Kemarin":t.toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"})},J=a=>a.reduce((t,s)=>s.type==="expense"?t-Number(s.amount):t+Number(s.amount),0);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"animate-in tx-page",children:[x.length>0&&(()=>{const a=b.filter(r=>r.is_mandatory).reduce((r,d)=>r+Number(d.budget_limit||0),0),t=A.income-A.expense-a,s=U-t;return e.jsxs("div",{className:"tx-stats",children:[e.jsxs("div",{className:"tx-stat",children:[e.jsx("span",{className:"tx-stat-label",children:"TOTAL SALDO"}),e.jsxs("span",{className:"tx-stat-val tabular",style:{color:t>=0?"#34d399":"#f87171"},children:[t>=0?"+":"−",f(Math.abs(t))]})]}),e.jsx("div",{className:"tx-stat-sep"}),e.jsxs("div",{className:"tx-stat",children:[e.jsx("span",{className:"tx-stat-label",children:"PENGELUARAN"}),e.jsxs("span",{className:"tx-stat-val tabular",style:{color:"#f87171"},children:["−",f(Math.max(0,s))]})]})]})})(),e.jsxs("div",{className:"tx-filter",children:[e.jsx("input",{className:"form-input tx-search",type:"text",placeholder:"Cari transaksi...",value:o.search,onChange:a=>w(t=>({...t,search:a.target.value}))}),e.jsxs("select",{className:"form-select tx-cat-select",value:o.category,onChange:a=>w(t=>({...t,category:a.target.value})),children:[e.jsx("option",{value:"",children:"Semua Kategori"}),b.map(a=>e.jsx("option",{value:a.id,children:a.name},a.id))]}),e.jsx("div",{className:"tx-type-toggle",children:[["","Semua"],["expense","Keluar"],["income","Masuk"]].map(([a,t])=>e.jsx("button",{className:`tx-type-btn${o.type===a?" active":""}`,onClick:()=>w(s=>({...s,type:a})),children:t},a))})]}),K?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:2},children:[...Array(6)].map((a,t)=>e.jsx("div",{className:"skeleton",style:{height:52}},t))}):j.length===0?e.jsxs("div",{className:"tx-empty",children:[e.jsx(me,{size:20}),e.jsx("span",{children:F?"Tidak ada yang cocok":"Belum ada transaksi"}),e.jsx("p",{children:F?"Coba ubah atau reset filter":"Tambah transaksi pertamamu"})]}):e.jsxs("div",{className:"tx-list",children:[Q.map(([a,t])=>{const s=J(t);return e.jsxs("div",{className:"tx-group",children:[e.jsxs("div",{className:"tx-group-head",children:[e.jsx("span",{className:"tx-group-date",children:Y(a)}),e.jsxs("span",{className:`tx-group-total tabular${s>=0?"":" neg"}`,children:[s>=0?"+":"",f(s)]})]}),e.jsx("div",{className:"tx-group-rows",children:t.map(r=>{var d;return e.jsxs("div",{className:"tx-row",style:{"--tc":r.type==="income"?"#34d399":"#f87171"},children:[e.jsx("div",{className:"tx-icon",style:{background:r.type==="income"?"rgba(52,211,153,0.1)":"rgba(248,113,113,0.1)",color:r.type==="income"?"#34d399":"#f87171"},children:r.type==="income"?e.jsx(pe,{size:13}):e.jsx(q,{size:13})}),e.jsxs("div",{className:"tx-info",children:[e.jsx("span",{className:"tx-desc",children:r.description||((d=r.categories)==null?void 0:d.name)||"Transaksi"}),r.categories&&e.jsx("span",{className:"tx-cat",style:{color:r.categories.color||"var(--text-muted)"},children:r.categories.name})]}),e.jsxs("span",{className:`tx-amount tabular${r.type==="income"?" inc":" exp"}`,children:[r.type==="income"?"+":"−",f(r.amount)]}),e.jsxs("div",{className:"tx-actions",children:[e.jsx("button",{className:"tx-act-btn",onClick:()=>{M(r),y(!0)},title:"Edit",children:e.jsx(xe,{size:11})}),e.jsx("button",{className:"tx-act-btn danger",onClick:()=>N(r.id),title:"Hapus",children:e.jsx(ue,{size:11})})]})]},r.id)})})]},a)}),(!o.type||o.type==="expense")&&(()=>{const a=b.filter(t=>t.is_mandatory&&Number(t.budget_limit)>0);return a.length?e.jsxs("div",{className:"tx-group",children:[e.jsxs("div",{className:"tx-group-head",children:[e.jsx("span",{className:"tx-group-date",children:"Pengeluaran Wajib"}),e.jsxs("span",{className:"tx-group-total tabular neg",children:["−",f(a.reduce((t,s)=>t+Number(s.budget_limit),0))]})]}),e.jsx("div",{className:"tx-group-rows",children:a.map(t=>e.jsxs("div",{className:"tx-row",style:{"--tc":"#f87171"},children:[e.jsx("div",{className:"tx-icon",style:{background:"rgba(248,113,113,0.1)",color:"#f87171"},children:e.jsx(q,{size:13})}),e.jsxs("div",{className:"tx-info",children:[e.jsx("span",{className:"tx-desc",children:t.name}),e.jsx("span",{className:"tx-cat",style:{color:"#f87171"},children:"Wajib · langsung dipotong"})]}),e.jsxs("span",{className:"tx-amount tabular exp",children:["−",f(t.budget_limit)]})]},t.id))})]}):null})()]}),e.jsx("style",{children:`
