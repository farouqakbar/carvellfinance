import{u as Q,e as V,d as X,r as p,s as y,j as e,L as k}from"./index-CIIpzWef.js";import{g as I,a as _,f as o}from"./formatCurrency-CwSiFA8N.js";import{T as Z}from"./TransactionForm-B4wvVUVQ.js";import{C as ee}from"./CurrencyInput-Cnzdqk4d.js";function ae(d){const[u,b]=d.split("-").map(Number),m=new Date(u,b-2,1);return`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}`}function te(d){const[u,b]=d.split("-").map(Number),m=new Date(u,b,1);return`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}`}function oe(){const{user:d}=Q(),u=V(),[b,m]=X(),[l,P]=p.useState(()=>b.get("month")||I()),[s,A]=p.useState({salary:0,totalExpense:0,totalIncome:0,categories:[],transactions:[],savings:[],categorySpend:[]}),[f,C]=p.useState(!0),[L,h]=p.useState(!1),[B,$]=p.useState(""),[R,g]=p.useState(!1);p.useEffect(()=>{z()},[l]);const D=a=>{P(a),m({month:a})},z=async()=>{var a;C(!0);try{const r=`${l}-01`,n=`${l}-31`,[c,x,H,K]=await Promise.all([y.from("salaries").select("*").eq("user_id",d.id).eq("month",l).maybeSingle(),y.from("transactions").select("*, categories(name, color, icon)").eq("user_id",d.id).gte("date",r).lte("date",n).order("date",{ascending:!1}),y.from("categories").select("*").eq("user_id",d.id).order("name"),y.from("savings").select("*").eq("user_id",d.id)]),N=x.data||[],O=H.data||[],W=N.filter(t=>t.type==="expense").reduce((t,i)=>t+Number(i.amount),0),Y=N.filter(t=>t.type==="income").reduce((t,i)=>t+Number(i.amount),0),v={};N.filter(t=>t.type==="expense"&&t.categories).forEach(t=>{const i=t.categories.name;v[i]||(v[i]={name:i,amount:0,color:t.categories.color,icon:t.categories.icon}),v[i].amount+=Number(t.amount)});const U=O.map(t=>{var F;const i=((F=v[t.name])==null?void 0:F.amount)||0,J=t.budget_limit>0?i/t.budget_limit*100:null;return{...t,spent:i,pct:J,overBudget:t.budget_limit>0&&i>t.budget_limit}}).sort((t,i)=>t.overBudget&&!i.overBudget?-1:!t.overBudget&&i.overBudget?1:(i.pct||0)-(t.pct||0));A({salary:((a=c.data)==null?void 0:a.amount)||0,totalExpense:W,totalIncome:Y,categories:U,transactions:N.slice(0,6),savings:K.data||[],categorySpend:Object.values(v).sort((t,i)=>i.amount-t.amount)})}finally{C(!1)}},q=async()=>{const a=parseFloat(B);a&&(await y.from("salaries").upsert({user_id:d.id,month:l,amount:a},{onConflict:"user_id,month"}),u("Gaji disimpan","success"),h(!1),$(""),z())},M=s.categories.filter(a=>a.budget_limit>0).reduce((a,r)=>a+r.budget_limit,0),S=s.salary+s.totalIncome-s.totalExpense,w=s.salary>0?s.totalExpense/s.salary*100:0,j=s.salary+s.totalIncome-s.totalExpense,G=l===I(),T=s.categories.filter(a=>a.overBudget),E=w>90?"var(--danger)":w>70?"var(--warning)":"var(--accent)";return e.jsxs("div",{className:"animate-in",children:[e.jsxs("div",{className:"dash-header",children:[e.jsxs("div",{className:"month-nav-group",children:[e.jsx("button",{className:"month-btn",onClick:()=>D(ae(l)),children:"‹"}),e.jsx("span",{className:"month-label-text",children:_(l)}),e.jsx("button",{className:"month-btn",onClick:()=>D(te(l)),disabled:G,children:"›"})]}),e.jsxs("div",{className:"flex gap-8",children:[e.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>h(!0),children:"Atur Gaji"}),e.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>g(!0),children:"+ Transaksi"})]})]}),T.length>0&&e.jsxs("div",{className:"alert-banner",children:[e.jsx("span",{children:"⚠"}),e.jsxs("span",{children:[e.jsx("strong",{children:"Overbudget"})," — ",T.map(a=>`${a.icon} ${a.name}`).join(", ")]})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16},children:[e.jsx("div",{className:"hero-card",children:f?e.jsx("div",{className:"skeleton",style:{height:88,borderRadius:8}}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"hero-top",children:[e.jsxs("div",{className:"hero-left",children:[e.jsxs("span",{className:"hero-eyebrow",children:["Saldo Bersih ",_(l)]}),e.jsxs("div",{className:`hero-balance ${S<0?"neg":""}`,children:[S<0&&e.jsx("span",{className:"hero-neg-sign",children:"-"}),o(Math.abs(S))]})]}),s.salary>0&&e.jsx("div",{className:"hero-right",children:e.jsxs("div",{className:"hero-salary-chip",children:[e.jsx("span",{className:"hero-salary-label",children:"Gaji"}),e.jsx("span",{className:"hero-salary-val tabular",children:o(s.salary)})]})})]}),s.salary>0?e.jsxs("div",{className:"hero-bar-section",children:[e.jsx("div",{className:"hero-bar-track",children:e.jsx("div",{className:"hero-bar-fill",style:{width:`${Math.min(w,100)}%`,background:E}})}),e.jsxs("div",{className:"hero-bar-labels",children:[e.jsxs("span",{children:[o(s.totalExpense)," dipakai"]}),e.jsxs("span",{style:{color:E,fontWeight:700},children:[w.toFixed(0),"%"]})]})]}):e.jsxs("div",{className:"hero-no-salary",children:[e.jsx("button",{className:"salary-cta",onClick:()=>h(!0),children:"+ Atur gaji bulan ini"}),e.jsx("span",{className:"salary-cta-hint",children:"untuk menghitung saldo bersih"})]})]})}),e.jsx("div",{className:"stats-strip",children:[{label:"Pemasukan",val:s.totalIncome,color:"var(--success)",sign:"+"},{label:"Pengeluaran",val:s.totalExpense,color:"var(--danger)",sign:"-"},{label:j>=0?"Bisa ditabung":"Defisit",val:Math.abs(j),color:j>=0?"var(--accent)":"var(--danger)",sign:j>=0?"":"-"}].map((a,r,n)=>e.jsxs("div",{className:"stat-col",children:[e.jsx("span",{className:"stat-col-label",children:a.label}),e.jsxs("span",{className:"stat-col-val tabular",style:{color:a.color},children:[a.sign,o(a.val)]})]},a.label))}),e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"sect-head",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"sect-title",children:"Budget Kategori"}),M>0&&e.jsxs("p",{className:"sect-sub",children:[o(s.totalExpense)," dari ",o(M)]})]}),e.jsx(k,{to:"/categories",className:"pill-link",children:"Kelola"})]}),f?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:[...Array(3)].map((a,r)=>e.jsx("div",{className:"skeleton",style:{height:44}},r))}):s.categories.filter(a=>a.budget_limit>0).length===0?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:"◈"}),e.jsx("span",{children:"Belum ada budget kategori. "}),e.jsx(k,{to:"/categories",className:"empty-hint-link",children:"Buat sekarang →"})]}):e.jsxs("div",{className:"budget-rows",children:[s.categories.filter(a=>a.budget_limit>0).map(a=>{const r=Math.min(a.spent/a.budget_limit*100,100),n=a.overBudget?"var(--danger)":r>=80?"var(--warning)":a.color;return e.jsxs("div",{className:"brow",children:[e.jsxs("div",{className:"brow-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${a.color}18`,color:a.color},children:a.icon}),e.jsx("span",{className:"brow-name",children:a.name}),a.overBudget&&e.jsx("span",{className:"badge badge-danger",style:{fontSize:"0.58rem",padding:"1px 6px"},children:"Over"}),!a.overBudget&&r>=80&&e.jsx("span",{className:"badge badge-warning",style:{fontSize:"0.58rem",padding:"1px 6px"},children:"Hampir"})]}),e.jsx("div",{className:"brow-bar-wrap",children:e.jsx("div",{className:"brow-bar",children:e.jsx("div",{className:"brow-bar-fill",style:{width:`${r}%`,background:n}})})}),e.jsxs("div",{className:"brow-right",children:[e.jsx("span",{className:"brow-spent tabular",style:{color:a.overBudget?"var(--danger)":"var(--text-primary)"},children:o(a.spent)}),e.jsxs("span",{className:"brow-limit tabular",children:["/",o(a.budget_limit)]})]}),e.jsxs("span",{className:"brow-pct",style:{color:n},children:[r.toFixed(0),"%"]})]},a.id)}),s.categories.filter(a=>a.budget_limit===0&&a.spent>0).map(a=>e.jsxs("div",{className:"brow no-limit",children:[e.jsxs("div",{className:"brow-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${a.color}18`,color:a.color},children:a.icon}),e.jsx("span",{className:"brow-name",children:a.name}),e.jsx("span",{className:"brow-no-limit-tag",children:"no limit"})]}),e.jsx("div",{className:"brow-bar-wrap"}),e.jsx("span",{className:"brow-spent tabular",children:o(a.spent)})]},a.id))]})]}),(f||s.savings.length>0)&&e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"sect-head",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"sect-title",children:"Tabungan"}),s.savings.length>0&&e.jsxs("p",{className:"sect-sub",children:[o(s.savings.reduce((a,r)=>a+Number(r.current_amount),0))," terkumpul"]})]}),e.jsx(k,{to:"/savings",className:"pill-link",children:"Kelola"})]}),f?e.jsx("div",{className:"savings-grid",children:[...Array(2)].map((a,r)=>e.jsx("div",{className:"skeleton",style:{height:68}},r))}):e.jsx("div",{className:"savings-grid",children:s.savings.map(a=>{const r=a.target_amount>0?Math.min(a.current_amount/a.target_amount*100,100):0,n=r>=100,c=a.deadline?Math.ceil((new Date(a.deadline)-new Date)/864e5):null,x=c!==null&&c<30&&!n;return e.jsxs("div",{className:`sv-chip ${n?"sv-done":x?"sv-urgent":""}`,children:[e.jsxs("div",{className:"sv-chip-top",children:[e.jsx("span",{className:"sv-chip-name",children:a.name}),e.jsx("span",{className:"sv-chip-pct",style:{color:n?"var(--success)":x?"var(--warning)":"var(--text-muted)"},children:n?"✓":`${r.toFixed(0)}%`})]}),e.jsxs("div",{className:"sv-chip-amounts",children:[e.jsx("span",{className:"sv-chip-cur tabular",children:o(a.current_amount)}),e.jsxs("span",{className:"sv-chip-tgt tabular",children:["/ ",o(a.target_amount)]})]}),e.jsx("div",{className:"sv-chip-bar",children:e.jsx("div",{className:"sv-chip-fill",style:{width:`${r}%`,background:n?"var(--success)":x?"var(--warning)":"linear-gradient(90deg, var(--accent), var(--info))"}})}),x&&c!==null&&e.jsx("span",{className:"sv-chip-deadline",children:c>0?`${c} hari lagi`:"Deadline lewat"})]},a.id)})})]}),e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"sect-head",children:[e.jsx("h3",{className:"sect-title",children:"Transaksi Terakhir"}),e.jsx(k,{to:"/transactions",className:"pill-link",children:"Lihat semua"})]}),f?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8,marginTop:12},children:[...Array(4)].map((a,r)=>e.jsx("div",{className:"skeleton",style:{height:42}},r))}):s.transactions.length===0?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:"↕"}),e.jsx("span",{children:"Belum ada transaksi bulan ini. "}),e.jsx("button",{className:"empty-hint-link",onClick:()=>g(!0),children:"Tambah sekarang →"})]}):e.jsx("div",{className:"tx-list",children:s.transactions.map(a=>{var r,n,c;return e.jsxs("div",{className:"tx-row",children:[e.jsx("div",{className:"tx-icon",style:{background:(r=a.categories)!=null&&r.color?`${a.categories.color}18`:"var(--bg-input)"},children:((n=a.categories)==null?void 0:n.icon)||(a.type==="income"?"↑":"↓")}),e.jsxs("div",{className:"tx-meta",children:[e.jsx("span",{className:"tx-desc",children:a.description||((c=a.categories)==null?void 0:c.name)||"Transaksi"}),e.jsx("span",{className:"tx-date",children:new Date(a.date).toLocaleDateString("id-ID",{day:"numeric",month:"short"})})]}),e.jsxs("span",{className:`tx-amount tabular ${a.type==="income"?"inc":"exp"}`,children:[a.type==="income"?"+":"−",o(a.amount)]})]},a.id)})})]})]}),L&&e.jsx("div",{className:"modal-overlay",onClick:()=>h(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:380},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("h2",{className:"modal-title",children:["Gaji ",_(l)]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>h(!1),children:"✕"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Gaji Bulan Ini"}),e.jsx(ee,{value:B,onChange:a=>$(a),autoFocus:!0})]}),e.jsxs("div",{className:"flex gap-8",children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>h(!1),children:"Batal"}),e.jsx("button",{className:"btn btn-primary",style:{flex:1},onClick:q,children:"Simpan"})]})]})}),R&&e.jsx("div",{className:"modal-overlay",onClick:()=>g(!1),children:e.jsxs("div",{className:"modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h2",{className:"modal-title",children:"Tambah Transaksi"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>g(!1),children:"✕"})]}),e.jsx(Z,{onSuccess:()=>{z(),g(!1)},onClose:()=>g(!1)})]})}),e.jsx("style",{children:`
        /* ── Header ───────────────────────────── */
        .dash-header {
