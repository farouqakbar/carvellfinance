import{u as me,e as pe,d as ge,r as h,s as d,j as e,L as E}from"./index-CwW1JINu.js";import{g as H,a as $,f as c}from"./formatCurrency-CwSiFA8N.js";import{T as he}from"./TransactionForm-CGELuGpc.js";import{C as xe}from"./CurrencyInput-CZfpviD7.js";import{i as m}from"./mandatoryCategories-BLLVk51K.js";function ue(l){const[b,j]=l.split("-").map(Number),g=new Date(b,j-2,1);return`${g.getFullYear()}-${String(g.getMonth()+1).padStart(2,"0")}`}function be(l){const[b,j]=l.split("-").map(Number),g=new Date(b,j,1);return`${g.getFullYear()}-${String(g.getMonth()+1).padStart(2,"0")}`}function Ne(){const{user:l}=me(),b=pe(),[j,g]=ge(),[o,Y]=h.useState(H()),[r,K]=h.useState({salary:0,totalExpense:0,totalIncome:0,categories:[],transactions:[],savings:[],savingsLogs:[],categorySpend:[],todayExpense:0,totalTabungan:0}),[f,q]=h.useState(!0),[U,x]=h.useState(!1),[F,P]=h.useState(""),[J,u]=h.useState(!1);h.useEffect(()=>{S()},[o]);const R=a=>{Y(a),g({month:a})},S=async()=>{var a,s;q(!0);try{const n=`${o}-01`,p=`${o}-31`,k=new Date().toISOString().split("T")[0],[v,te,M,re,se,ie,ne,oe]=await Promise.all([d.from("salaries").select("*").eq("user_id",l.id).eq("month",o).maybeSingle(),d.from("transactions").select("*, categories(name, color, icon)").eq("user_id",l.id).gte("date",n).lte("date",p).order("date",{ascending:!1}),d.from("categories").select("*").eq("user_id",l.id).order("name"),d.from("savings").select("*").eq("user_id",l.id),d.from("savings_log").select("*").eq("user_id",l.id).eq("month",o),d.from("transactions").select("amount").eq("user_id",l.id).eq("date",k).eq("type","expense"),d.from("category_budgets").select("*").eq("user_id",l.id).eq("month",o),d.from("category_budgets").select("budget_limit, category_id").eq("user_id",l.id).lte("month",o)]),z=te.data||[],D={};(ne.data||[]).forEach(t=>{D[t.category_id]=Number(t.budget_limit)});const O=(M.data||[]).map(t=>({...t,budget_limit:D[t.id]!==void 0?D[t.id]:Number(t.budget_limit)})),le=z.filter(t=>t.type==="expense").reduce((t,i)=>t+Number(i.amount),0),ce=z.filter(t=>t.type==="income").reduce((t,i)=>t+Number(i.amount),0),y={};z.filter(t=>t.type==="expense"&&t.categories).forEach(t=>{const i=t.categories.name;y[i]||(y[i]={name:i,amount:0,color:t.categories.color,icon:t.categories.icon}),y[i].amount+=Number(t.amount)});const de=O.map(t=>{var _;const i=((_=y[t.name])==null?void 0:_.amount)||0,w=t.budget_limit>0?i/t.budget_limit*100:null;return{...t,spent:i,pct:w,overBudget:t.budget_limit>0&&i>t.budget_limit}}).sort((t,i)=>t.overBudget&&!i.overBudget?-1:!t.overBudget&&i.overBudget?1:(i.pct||0)-(t.pct||0));K({salary:((a=v.data)==null?void 0:a.amount)||0,totalExpense:le,totalIncome:ce,categories:de,transactions:z.slice(0,5),savings:re.data||[],savingsLogs:se.data||[],todayExpense:(ie.data||[]).reduce((t,i)=>t+Number(i.amount),0),totalTabungan:(oe.data||[]).filter(t=>{const i=O.find(w=>w.id===t.category_id);return i&&i.name==="Tabungan Bulanan"}).reduce((t,i)=>t+Number(i.budget_limit),0),categorySpend:Object.values(y).sort((t,i)=>i.amount-t.amount)});const W=((s=v.data)==null?void 0:s.amount)||0;if(W>0){const t=(M.data||[]).filter(i=>m(i)&&!(Number(i.budget_limit)>0));if(t.length>0){const i=Math.round(Number(W)*.15);await Promise.all(t.map(_=>d.from("categories").update({budget_limit:i}).eq("id",_.id)));const{data:w}=await d.from("categories").select("*").eq("user_id",l.id).order("name");M.data=w}}}finally{q(!1)}},Q=async()=>{const a=parseFloat(F);if(!a)return;await d.from("salaries").upsert({user_id:l.id,month:o,amount:a},{onConflict:"user_id,month"});const s=r.categories.filter(n=>m(n)&&!(Number(n.budget_limit)>0));if(s.length>0){const n=Math.round(a*.15);await Promise.all(s.map(p=>d.from("categories").update({budget_limit:n}).eq("id",p.id)))}b("Gaji disimpan","success"),x(!1),P(""),S()};r.categories.filter(a=>a.budget_limit>0).reduce((a,s)=>a+s.budget_limit,0);const V=o===H(),A=r.categories.filter(a=>a.overBudget),X=.15,Z=r.categories.filter(a=>m(a)).reduce((a,s)=>{const n=Number(s.budget_limit)>0?Number(s.budget_limit):r.salary>0?Math.round(r.salary*X):0;return a+n},0),ee=r.categories.filter(a=>m(a)).reduce((a,s)=>a+(s.spent||0),0),B=Math.max(0,Z-ee),T=r.totalExpense+B,C=r.salary+r.totalIncome-T,N=r.salary>0?T/r.salary*100:0,I=N>90?"var(--danger)":N>70?"var(--warning)":"var(--accent)",L=r.categories.filter(a=>a.name==="Tabungan Bulanan"&&a.budget_limit>0).reduce((a,s)=>a+Number(s.budget_limit),0),G=r.salary>0?r.salary-L:0;G-r.totalExpense;const ae=r.salary>0&&L>0&&r.totalExpense>G;return e.jsxs("div",{className:"animate-in",children:[e.jsxs("div",{className:"dash-header",children:[e.jsxs("div",{className:"month-nav-group",children:[e.jsx("button",{className:"month-btn",onClick:()=>R(ue(o)),children:"‹"}),e.jsx("span",{className:"month-label-text",children:$(o)}),e.jsx("button",{className:"month-btn",onClick:()=>R(be(o)),disabled:V,children:"›"})]}),e.jsxs("div",{className:"flex gap-8",children:[e.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>x(!0),children:"Atur Gaji"}),e.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>u(!0),children:"+ Transaksi"})]})]}),A.length>0&&e.jsxs("div",{className:"alert-banner",children:[e.jsx("span",{children:"⚠"}),e.jsxs("span",{children:[e.jsx("strong",{children:"Overbudget"})," — ",A.map(a=>`${a.icon} ${a.name}`).join(", ")]})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16},children:[e.jsx("div",{className:"hero-card",children:f?e.jsx("div",{className:"skeleton",style:{height:88,borderRadius:8}}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"hero-top",children:[e.jsxs("div",{className:"hero-left",children:[e.jsx("span",{className:"hero-date",children:new Date().toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"})}),e.jsxs("span",{className:"hero-eyebrow",children:["Saldo Bersih ",$(o)]}),e.jsxs("div",{className:`hero-balance ${C<0?"neg":""}`,children:[C<0&&e.jsx("span",{className:"hero-neg-sign",children:"-"}),c(Math.abs(C))]})]}),e.jsxs("div",{className:"hero-right",children:[r.salary>0&&e.jsxs("div",{className:"hero-chip",children:[e.jsx("span",{className:"hero-chip-label",children:"Gaji"}),e.jsx("span",{className:"hero-chip-val tabular",children:c(r.salary)})]}),e.jsxs("div",{className:"hero-chip",children:[e.jsx("span",{className:"hero-chip-label",children:"Total Tabungan"}),e.jsx("span",{className:"hero-chip-val tabular",style:{color:r.totalTabungan>0?"var(--success)":"var(--text-muted)"},children:c(r.totalTabungan)})]})]})]}),r.salary>0?e.jsxs("div",{className:"hero-bar-section",children:[e.jsx("div",{className:"hero-bar-track",children:e.jsx("div",{className:"hero-bar-fill",style:{width:`${Math.min(N,100)}%`,background:I}})}),e.jsxs("div",{className:"hero-bar-labels",children:[e.jsxs("span",{children:[c(r.totalExpense)," dipakai"]}),e.jsxs("span",{style:{color:I,fontWeight:700},children:[N.toFixed(0),"%"]})]})]}):e.jsxs("div",{className:"hero-no-salary",children:[e.jsx("button",{className:"salary-cta",onClick:()=>x(!0),children:"+ Atur gaji bulan ini"}),e.jsx("span",{className:"salary-cta-hint",children:"untuk menghitung saldo bersih"})]})]})}),e.jsxs("div",{className:"stats-strip",children:[e.jsxs("div",{className:"stat-col",children:[e.jsx("span",{className:"stat-col-label",children:"Pemasukan"}),e.jsxs("span",{className:"stat-col-val tabular",style:{color:"var(--success)"},children:["+",c(r.totalIncome)]})]}),e.jsxs("div",{className:"stat-col",children:[e.jsx("span",{className:"stat-col-label",children:"Pengeluaran"}),e.jsxs("span",{className:"stat-col-val tabular",style:{color:ae?"var(--danger)":"var(--text-primary)"},children:["-",c(T)]}),B>0&&e.jsxs("span",{className:"stat-col-sub",children:["+",c(B)," wajib"]})]}),e.jsxs("div",{className:"stat-col",children:[e.jsx("span",{className:"stat-col-label",children:"Belanja Hari Ini"}),e.jsx("span",{className:"stat-col-val tabular",style:{color:r.todayExpense>0?"var(--danger)":"var(--text-muted)"},children:r.todayExpense>0?`-${c(r.todayExpense)}`:"—"}),r.todayExpense>0&&r.salary>0&&e.jsxs("span",{className:"stat-col-sub",children:[(r.todayExpense/r.salary*100).toFixed(1),"% gaji"]})]})]}),e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"sect-head",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"sect-title",children:"Pengeluaran Wajib"}),e.jsx("p",{className:"sect-sub",children:"Dipotong langsung dari gaji"})]}),e.jsx(E,{to:"/categories",className:"pill-link",children:"Kelola"})]}),f?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[...Array(3)].map((a,s)=>e.jsx("div",{className:"skeleton",style:{height:36}},s))}):e.jsx("div",{className:"wajib-rows",children:r.categories.filter(a=>m(a)).map(a=>{const s=Number(a.budget_limit)>0?Number(a.budget_limit):r.salary>0?Math.round(r.salary*.15):0,n=r.salary>0&&s>0?Math.round(s/r.salary*100):null;return e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${a.color}18`,color:a.color},children:a.icon}),e.jsx("span",{className:"brow-name",children:a.name})]}),e.jsxs("div",{className:"wajib-right",children:[n&&e.jsxs("span",{className:"wajib-pct",children:[n,"%"]}),e.jsx("span",{className:"wajib-amount tabular",children:c(s)})]})]},a.id)})})]}),(f||r.categories.filter(a=>!m(a)&&a.budget_limit>0).length>0)&&e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"sect-head",children:e.jsxs("div",{children:[e.jsx("h3",{className:"sect-title",children:"Budget Kategori"}),r.categories.filter(a=>!m(a)&&a.budget_limit>0).length>0&&e.jsxs("p",{className:"sect-sub",children:[c(r.categories.filter(a=>!m(a)).reduce((a,s)=>a+(s.spent||0),0))," dari ",c(r.categories.filter(a=>!m(a)&&a.budget_limit>0).reduce((a,s)=>a+Number(s.budget_limit),0))]})]})}),f?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:[...Array(2)].map((a,s)=>e.jsx("div",{className:"skeleton",style:{height:44}},s))}):e.jsx("div",{className:"budget-rows",children:r.categories.filter(a=>!m(a)&&a.budget_limit>0).map(a=>{const s=a.spent/a.budget_limit*100,n=Math.min(s,100),p=!a.overBudget&&s>=100,k=!a.overBudget&&s>=80&&s<100,v=a.overBudget?"var(--danger)":p?"var(--success)":k?"var(--warning)":a.color;return e.jsxs("div",{className:"brow",children:[e.jsxs("div",{className:"brow-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${a.color}18`,color:a.color},children:a.icon}),e.jsx("span",{className:"brow-name",children:a.name}),a.overBudget&&e.jsx("span",{className:"badge badge-danger",style:{fontSize:"0.6rem",padding:"2px 7px"},children:"Over"}),p&&e.jsx("span",{className:"badge badge-success",style:{fontSize:"0.6rem",padding:"2px 7px"},children:"Penuh"}),k&&e.jsx("span",{className:"badge badge-warning",style:{fontSize:"0.6rem",padding:"2px 7px"},children:"Hampir"})]}),e.jsx("div",{className:"brow-bar-wrap",children:e.jsx("div",{className:"brow-bar",children:e.jsx("div",{className:"brow-bar-fill",style:{width:`${n}%`,background:v}})})}),e.jsxs("div",{className:"brow-right",children:[e.jsx("span",{className:"brow-spent tabular",style:{color:a.overBudget?"var(--danger)":"var(--text-primary)"},children:c(a.spent)}),e.jsxs("span",{className:"brow-limit tabular",children:["/",c(a.budget_limit)]})]}),e.jsxs("span",{className:"brow-pct",style:{color:v},children:[n.toFixed(0),"%"]})]},a.id)})})]}),e.jsxs("div",{className:"card",style:{borderStyle:"dashed"},children:[e.jsxs("div",{className:"sect-head",children:[e.jsx("h3",{className:"sect-title",children:"Rencana Bulan Depan"}),e.jsx(E,{to:"/savings",className:"pill-link",children:"Atur →"})]}),e.jsx("p",{style:{fontSize:"0.78rem",color:"var(--text-muted)",margin:0},children:"Rencanakan pengeluaran bulan depan secara rinci di halaman Rencana."})]}),e.jsxs("div",{className:"card",children:[e.jsxs("div",{className:"sect-head",children:[e.jsx("h3",{className:"sect-title",children:"Transaksi Terakhir"}),e.jsx(E,{to:`/transactions?month=${o}`,className:"pill-link",children:"Lihat semua"})]}),f?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8,marginTop:12},children:[...Array(4)].map((a,s)=>e.jsx("div",{className:"skeleton",style:{height:42}},s))}):r.transactions.length===0?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:"↕"}),e.jsx("span",{children:"Belum ada transaksi bulan ini. "}),e.jsx("button",{className:"empty-hint-link",onClick:()=>u(!0),children:"Tambah sekarang →"})]}):e.jsx("div",{className:"tx-list",children:r.transactions.map(a=>{var s,n,p;return e.jsxs("div",{className:"tx-row",children:[e.jsx("div",{className:"tx-icon",style:{background:(s=a.categories)!=null&&s.color?`${a.categories.color}18`:"var(--bg-input)"},children:((n=a.categories)==null?void 0:n.icon)||(a.type==="income"?"↑":"↓")}),e.jsxs("div",{className:"tx-meta",children:[e.jsx("span",{className:"tx-desc",children:a.description||((p=a.categories)==null?void 0:p.name)||"Transaksi"}),e.jsx("span",{className:"tx-date",children:new Date(a.date).toLocaleDateString("id-ID",{day:"numeric",month:"short"})})]}),e.jsxs("span",{className:`tx-amount tabular ${a.type==="income"?"inc":"exp"}`,children:[a.type==="income"?"+":"−",c(a.amount)]})]},a.id)})})]})]}),U&&e.jsx("div",{className:"modal-overlay",onClick:()=>x(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:380},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("h2",{className:"modal-title",children:["Gaji ",$(o)]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>x(!1),children:"✕"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Gaji Bulan Ini"}),e.jsx(xe,{value:F,onChange:a=>P(a),autoFocus:!0})]}),e.jsxs("div",{className:"flex gap-8",children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>x(!1),children:"Batal"}),e.jsx("button",{className:"btn btn-primary",style:{flex:1},onClick:Q,children:"Simpan"})]})]})}),J&&e.jsx("div",{className:"modal-overlay",onClick:()=>u(!1),children:e.jsxs("div",{className:"modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h2",{className:"modal-title",children:"Tambah Transaksi"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>u(!1),children:"✕"})]}),e.jsx(he,{onSuccess:()=>{S(),u(!1)},onClose:()=>u(!1)})]})}),e.jsx("style",{children:`
        /* ── Header ───────────────────────────── */
        .dash-header {
