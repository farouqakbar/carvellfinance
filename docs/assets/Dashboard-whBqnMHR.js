import{F as Ga,H as Ya,K as Ua,J as Ja,D as m,w as re,B as e,z as B,G as Qa,y as ma,A as Xa,E as u,v as p,f as Va,I as Za,L as Y,d as xe,n as ga,m as pa,c as ba,a as ne,b as ua,s as y,C as ha}from"./index-CKUrIL16.js";import{T as et}from"./TransactionForm-BAUmVlor.js";import{C as at}from"./CategoryForm-CwLIOoXt.js";import{a as fe,i as U,d as xa,f as tt,c as st,e as rt,C as nt}from"./ConfirmModal-Bybi8hPX.js";const it=15;function lt(d){const[J,R]=d.split("-").map(Number),j=new Date(J,R-2,1);return`${j.getFullYear()}-${String(j.getMonth()+1).padStart(2,"0")}`}function je(d){const[J,R]=d.split("-").map(Number),j=new Date(J,R,1);return`${j.getFullYear()}-${String(j.getMonth()+1).padStart(2,"0")}`}function gt(){var Ve,Ze,ea,aa,ta,sa,ra;const{user:d,updateProfile:J}=Ga(),{setHeader:R}=Ya(),j=Ua(),[fa,ja]=Ja(),[o,va]=m.useState(()=>fa.get("month")||re()),[s,ya]=m.useState({salary:0,totalExpense:0,totalIncome:0,categories:[],transactions:[],savings:[],savingsLogs:[],categorySpend:[],hutangList:[],hutangTabunganList:[],todayExpense:0,totalTabungan:0,tabunganPerMonth:[],nextMonthPlans:[],cumulativeBalance:0,cumulativeMandatoryBudget:0,gajiTx:null,gajiCatId:null}),[v,Be]=m.useState(!0),[wa,H]=m.useState(!1),[Na,ve]=m.useState(!1),[k,I]=m.useState(null),[Ie,Q]=m.useState(!1),[ie,ka]=m.useState(null),[X,ye]=m.useState(null),[Sa,le]=m.useState(!1),[za,we]=m.useState(!1),[_a,q]=m.useState(!1),[Ca,V]=m.useState(!1),[Ta,oe]=m.useState(!1),[w,Z]=m.useState(null),[E,F]=m.useState(null),[ee,ae]=m.useState(null),[Fe,Ae]=m.useState(!1),[Ma,te]=m.useState(!1),[Ne,De]=m.useState(""),[Ee,Le]=m.useState(!1),[A,de]=m.useState({amount:"",note:"",date:""}),[$e,We]=m.useState(!1),[ke,Se]=m.useState(!1),[T,ze]=m.useState(()=>Number(re().split("-")[0])),[Pa,Ba]=m.useState(!1),[ce,Re]=m.useState("transaction"),[_e,He]=m.useState(0),[Ia,qe]=m.useState(0),[Fa,Ke]=m.useState(0);m.useEffect(()=>{if(d.recording_start_month&&o<d.recording_start_month){me(d.recording_start_month);return}L()},[o,d==null?void 0:d.recording_start_month]),m.useEffect(()=>{const a=o===re(),t=!!d.recording_start_month&&o<=d.recording_start_month,[i,c]=d.recording_start_month?d.recording_start_month.split("-").map(Number):[0,0],b=re(),[h,C]=b.split("-").map(Number),n=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Ags","Sep","Okt","Nov","Des"];return R(e.jsxs(e.Fragment,{children:[ke&&e.jsx("div",{style:{position:"fixed",inset:0,zIndex:299},onClick:()=>Se(!1)}),e.jsxs("div",{className:"month-nav-group",children:[e.jsx("button",{className:"month-btn",onClick:()=>me(lt(o)),disabled:t,children:"‹"}),e.jsx("span",{className:"month-label-text month-label-clickable",onClick:()=>{ze(Number(o.split("-")[0])),Se(g=>!g)},children:B(o)}),e.jsx("button",{className:"month-btn",onClick:()=>me(je(o)),disabled:a,children:"›"}),ke&&e.jsxs("div",{className:"month-picker-popup",onMouseDown:g=>g.preventDefault(),children:[e.jsxs("div",{className:"mp-year-row",children:[e.jsx("button",{className:"mp-year-btn",onClick:()=>ze(g=>g-1),disabled:!!d.recording_start_month&&T<=i,children:"‹"}),e.jsx("span",{className:"mp-year-label",children:T}),e.jsx("button",{className:"mp-year-btn",onClick:()=>ze(g=>g+1),disabled:T>=h,children:"›"})]}),e.jsx("div",{className:"mp-grid",children:n.map((g,M)=>{const x=M+1,z=`${T}-${String(x).padStart(2,"0")}`,f=T>h||T===h&&x>C,_=!!d.recording_start_month&&(T<i||T===i&&x<c);return e.jsx("button",{className:`mp-month-btn${z===o?" mp-active":""}`,disabled:f||_,onClick:()=>{me(z),Se(!1)},children:g},z)})})]})]})]})),()=>R(null)},[o,ke,T,d==null?void 0:d.recording_start_month]),Qa();const me=a=>{va(a),ja({month:a})},L=async()=>{Be(!0);try{const a=`${o}-01`,t=ma(o),i=Xa(),c=je(o),b=d.recording_start_month;let h=u.from("transactions").select("amount, type").eq("user_id",d.id).lt("date",a);b&&(h=h.gte("date",`${b}-01`));let C=u.from("category_budgets").select("budget_limit, category_id, month, categories(is_mandatory, name, category_type)").eq("user_id",d.id).lte("month",o);b&&(C=C.gte("month",b));const[n,g,M,x,z,f,_,W,O,Te,be]=await Promise.all([u.from("transactions").select("*, categories(name, color, icon)").eq("user_id",d.id).gte("date",a).lte("date",t).order("date",{ascending:!1}),Promise.all([u.from("categories").select("*").eq("user_id",d.id).is("month",null),u.from("categories").select("*").eq("user_id",d.id).eq("month",o)]).then(([r,l])=>{const P=[...r.data||[],...l.data||[]].sort((he,Oa)=>he.name.localeCompare(Oa.name)),ca=new Set;return{data:P.filter(he=>ca.has(he.name)?!1:(ca.add(he.name),!0))}}),u.from("savings").select("*").eq("user_id",d.id),u.from("savings_log").select("*").eq("user_id",d.id).eq("month",o),u.from("transactions").select("amount").eq("user_id",d.id).eq("date",i).eq("type","expense"),u.from("category_budgets").select("category_id, budget_limit").eq("user_id",d.id).eq("month",o),C,u.from("plans").select("*").eq("user_id",d.id).eq("target_month",c).eq("done",!1).order("created_at",{ascending:!0}),h,u.from("hutang").select("id, nama, amount, due_date, sumber, jenis, lunas").eq("user_id",d.id).lte("month",o).eq("lunas",!1).order("due_date",{ascending:!0,nullsFirst:!1}),u.from("hutang").select("id, nama, amount, jenis, lunas, created_at").eq("user_id",d.id).lte("month",o).eq("sumber","tabungan").order("created_at",{ascending:!1})]),G=n.data||[],Me={};(f.data||[]).forEach(r=>{Me[r.category_id]=Number(r.budget_limit)});let na=(g.data||[]).map(r=>{const l=Me[r.id]!==void 0?Me[r.id]:0;return{...r,budget_limit:l,budget_set:l>0}});const D=na.find(r=>fe(r)),ia=D?G.filter(r=>r.type==="income"&&r.category_id===D.id):[],la=ia.reduce((r,l)=>r+Number(l.amount),0),qa=na,oa=G.filter(r=>r.type==="expense").reduce((r,l)=>r+Number(l.amount),0),da=G.filter(r=>r.type==="income"&&r.category_id!==(D==null?void 0:D.id)).reduce((r,l)=>r+Number(l.amount),0),Pe={};G.filter(r=>r.type==="expense"&&r.category_id).forEach(r=>{Pe[r.category_id]=(Pe[r.category_id]||0)+Number(r.amount)});const ue={};G.filter(r=>r.type==="expense"&&r.categories).forEach(r=>{const l=r.categories.name;ue[l]||(ue[l]={name:l,amount:0,color:r.categories.color,icon:r.categories.icon}),ue[l].amount+=Number(r.amount)});const Ka=qa.map(r=>{const l=Pe[r.id]||0,P=r.budget_limit>0?l/r.budget_limit*100:null;return{...r,spent:l,pct:P,overBudget:r.budget_limit>0&&l>r.budget_limit}}).sort((r,l)=>r.overBudget&&!l.overBudget?-1:!r.overBudget&&l.overBudget?1:(l.pct||0)-(r.pct||0));ya({salary:la,totalExpense:oa,totalIncome:da,categories:Ka,transactions:G.slice(0,5),savings:M.data||[],savingsLogs:x.data||[],todayExpense:(z.data||[]).reduce((r,l)=>r+Number(l.amount),0),tabunganPerMonth:(_.data||[]).filter(r=>{var l,P;return(((l=r.categories)==null?void 0:l.category_type)==="savings"||((P=r.categories)==null?void 0:P.name)==="Tabungan Bulanan")&&Number(r.budget_limit)>0}).sort((r,l)=>r.month.localeCompare(l.month)),totalTabungan:(_.data||[]).filter(r=>{var l,P;return((l=r.categories)==null?void 0:l.category_type)==="savings"||((P=r.categories)==null?void 0:P.name)==="Tabungan Bulanan"}).reduce((r,l)=>r+Number(l.budget_limit),0)+(d.tabungan_awal||0)-(be.data||[]).filter(r=>!r.lunas).reduce((r,l)=>r+Number(l.amount),0),categorySpend:Object.values(ue).sort((r,l)=>l.amount-r.amount),nextMonthPlans:W.data||[],gajiTx:ia[0]||null,gajiCatId:(D==null?void 0:D.id)||null,hutangList:Te.data||[],hutangTabunganList:be.data||[],cumulativeBalance:(O.data||[]).reduce((r,l)=>r+(l.type==="income"?Number(l.amount):-Number(l.amount)),0)+la+da-oa+(d.saldo_awal||0),cumulativeMandatoryBudget:(_.data||[]).filter(r=>{var l;return((l=r.categories)==null?void 0:l.is_mandatory)===!0}).reduce((r,l)=>r+Number(l.budget_limit),0)})}finally{Be(!1)}},Aa=a=>{const t=String(Math.round(a.budget_limit||0)),i=s.salary>0&&a.budget_limit>0?(a.budget_limit/s.salary*100).toFixed(1):"";I({id:a.id,nominal:t,pct:i})},Da=a=>{const t=parseFloat(a)||0,i=s.salary>0&&t>0?(t/s.salary*100).toFixed(1):"";I(c=>({...c,nominal:a,pct:i}))},Oe=a=>{const t=parseFloat(a)||0,i=s.salary>0&&t>0?String(Math.round(t/100*s.salary)):"";I(c=>({...c,pct:a,nominal:i}))},Ea=async()=>{const a=parseFloat(k.nominal)||0,[t,i]=await Promise.all([u.from("category_budgets").upsert({user_id:d.id,category_id:k.id,month:o,budget_limit:a},{onConflict:"category_id,month"}),u.from("categories").update({budget_limit:a}).eq("id",k.id)]),c=t.error||i.error;if(c){j(c.message,"error");return}j("Budget disimpan","success"),I(null),L()},La=async()=>{const a=`${o}-01`,t=ma(o),[i,c]=await Promise.all([u.from("transactions").delete().eq("category_id",X.id).gte("date",a).lte("date",t),u.from("category_budgets").delete().eq("category_id",X.id).eq("month",o)]);if(i.error||c.error){j((i.error||c.error).message,"error");return}const{error:b}=await u.from("categories").delete().eq("id",X.id);if(b){j(b.message,"error");return}j("Kategori dihapus","success"),ye(null),L()};s.categories.filter(a=>a.budget_limit>0).reduce((a,t)=>a+t.budget_limit,0),re();const $=s.categories.filter(a=>a.overBudget);m.useEffect(()=>{if($.length<=1){He(0);return}const a=setInterval(()=>He(t=>(t+1)%$.length),2e3);return()=>clearInterval(a)},[$.length]);const Ge=s.categories.filter(a=>U(a)).reduce((a,t)=>a+Number(t.budget_limit||0),0),$a=s.categories.filter(a=>U(a)).reduce((a,t)=>a+(t.spent||0),0),Wa=Math.max(0,Ge-$a),Ye=s.totalExpense+Wa;s.salary+s.totalIncome-Ye,s.salary>0&&Ye/s.salary*100;const Ce=s.categories.filter(a=>xa(a)&&a.budget_limit>0).reduce((a,t)=>a+Number(t.budget_limit),0);s.categories.filter(a=>fe(a));const Ra=s.categories.filter(a=>xa(a)),Ue=s.categories.filter(a=>tt(a)),Je=s.categories.filter(a=>st(a)),Qe=s.categories.filter(a=>rt(a)),Ha=[{label:"Wajib",spent:Ue.reduce((a,t)=>a+(t.spent||0),0),budget:Ue.reduce((a,t)=>a+Number(t.budget_limit||0),0),color:"#f87171",action:()=>le(!0)},{label:"Rutin",spent:Je.reduce((a,t)=>a+(t.spent||0),0),budget:Je.reduce((a,t)=>a+Number(t.budget_limit||0),0),color:"#fbbf24"},{label:"Tambahan",spent:Qe.reduce((a,t)=>a+(t.spent||0),0),budget:Qe.reduce((a,t)=>a+Number(t.budget_limit||0),0),color:"#f97316"}],S=Ra.filter(a=>Number(a.budget_limit)>0),N=Ha.filter(a=>a.spent>0),ge=S.length>0?Ia%S.length:0,se=N.length>0?Fa%N.length:0;m.useEffect(()=>{if(v||S.length<=1)return;const a=setInterval(()=>qe(t=>(t+1)%S.length),2500);return()=>clearInterval(a)},[v,S.length]),m.useEffect(()=>{if(v||N.length<=1)return;const a=setInterval(()=>Ke(t=>(t+1)%N.length),3e3);return()=>clearInterval(a)},[v,N.length]);const pe=s.cumulativeBalance-s.cumulativeMandatoryBudget,K=(s.hutangList||[]).filter(a=>a.jenis==="hutang").reduce((a,t)=>a+Number(t.amount),0);s.salary-s.totalExpense-Ce,s.salary>0&&s.totalExpense/s.salary*100;const Xe=s.salary>0?s.salary-Ce:0;return Xe-s.totalExpense,s.salary>0&&Ce>0&&s.totalExpense>Xe,e.jsxs("div",{className:"animate-in",children:[e.jsxs("div",{className:"db-page",children:[e.jsxs("div",{className:"db-hero",children:[e.jsx("span",{className:"db-eyebrow",children:K>0?"SALDO BERSIH":"TOTAL SALDO"}),v?e.jsx("div",{className:"skeleton",style:{height:56,width:220,borderRadius:8,marginTop:6}}):e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"flex-start",gap:6},children:[e.jsxs("div",{className:`db-balance${pe-K<0?" neg":""}`,children:[pe-K<0&&e.jsx("span",{className:"db-neg-sign",children:"−"}),p(Math.abs(pe-K))]}),K>0&&e.jsxs("button",{className:"db-hutang-chip",onClick:()=>oe(!0),children:[e.jsx("span",{className:"db-hutang-chip-label",children:"+ hutang"}),e.jsx("span",{className:"db-hutang-chip-amount",children:p(pe)}),e.jsx("span",{className:"db-hutang-chip-arrow",children:"›"})]})]}),e.jsx("div",{className:"db-hero-chips",children:!v&&s.nextMonthPlans.length>0&&e.jsxs("button",{className:"db-rencana-chip",onClick:()=>q(!0),children:[e.jsx(Va,{size:11}),s.nextMonthPlans.length," rencana bulan depan"]})})]}),!v&&e.jsxs("div",{className:"db-stats-grid",children:[e.jsxs("button",{className:"db-stat db-stat-btn",onClick:()=>{var a,t;de({amount:s.gajiTx?String(s.gajiTx.amount):"",note:((a=s.gajiTx)==null?void 0:a.description)||"",date:((t=s.gajiTx)==null?void 0:t.date)||`${o}-01`}),V(!0)},children:[e.jsx("span",{className:"db-stat-label",children:"PEMASUKAN"}),e.jsx("span",{className:"db-stat-val tabular",style:{color:s.salary>0?"#34d399":"var(--text-muted)"},children:s.salary>0?`+${p(s.salary)}`:"—"}),e.jsx("span",{className:"db-stat-sub",children:s.salary>0?"bulan ini":"belum dicatat"})]}),e.jsxs("button",{className:"db-stat db-stat-btn",onClick:()=>we(!0),children:[e.jsx("span",{className:"db-stat-label",children:"TABUNGAN"}),S.length>0?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"db-stat-val tabular",style:{color:"#818cf8"},children:p(((Ve=S[ge])==null?void 0:Ve.budget_limit)||0)}),e.jsx("span",{className:"db-stat-sub",style:{color:(Ze=S[ge])==null?void 0:Ze.color},children:((ea=S[ge])==null?void 0:ea.name)||"—"}),S.length>1&&e.jsx("div",{className:"db-sub-dots",children:S.map((a,t)=>e.jsx("span",{className:`db-sub-dot${ge===t?" active":""}`,onClick:i=>{i.stopPropagation(),qe(t)}},t))})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"db-stat-val tabular",style:{color:"var(--text-muted)"},children:"—"}),e.jsx("span",{className:"db-stat-sub",children:"belum diatur"})]})]}),e.jsxs("button",{className:"db-stat db-stat-btn",onClick:()=>{var a,t;return(t=(a=N[se])==null?void 0:a.action)==null?void 0:t.call(a)},children:[e.jsx("span",{className:"db-stat-label",children:"PENGELUARAN"}),N.length>0?e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"db-stat-val tabular",style:{color:"#f87171"},children:["−",p(((aa=N[se])==null?void 0:aa.spent)||0)]}),e.jsx("span",{className:"db-stat-sub",style:{color:(ta=N[se])==null?void 0:ta.color},children:(sa=N[se])==null?void 0:sa.label}),N.length>1&&e.jsx("div",{className:"db-sub-dots",children:N.map((a,t)=>e.jsx("span",{className:`db-sub-dot${se===t?" active":""}`,onClick:i=>{i.stopPropagation(),Ke(t)}},t))})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"db-stat-val tabular",style:{color:"var(--text-muted)"},children:"—"}),e.jsx("span",{className:"db-stat-sub",children:"belum ada"})]})]}),e.jsxs("button",{className:"db-stat db-stat-btn",onClick:()=>q(!0),children:[e.jsx("span",{className:"db-stat-label",children:"RENCANA"}),e.jsx("span",{className:"db-stat-val tabular",style:{color:s.nextMonthPlans.length>0?"#fbbf24":"var(--text-muted)"},children:s.nextMonthPlans.length>0?s.nextMonthPlans.length:"—"}),e.jsx("span",{className:"db-stat-sub",children:s.nextMonthPlans.length>0?"rencana bulan depan":"belum ada rencana"})]})]}),v&&e.jsx("div",{className:"skeleton",style:{height:120,borderRadius:"var(--radius-lg)"}}),!v&&s.todayExpense>0&&(()=>{const a=d.budget_harian||0,t=s.todayExpense,i=a>0&&t>=a,c=a>0&&t/a>=.8&&!i,b=a>0&&!i&&!c,h=i?"#f87171":c?"#fbbf24":b?"#34d399":"#818cf8",C=i?"rgba(248,113,113,0.06)":c?"rgba(251,191,36,0.06)":b?"rgba(52,211,153,0.06)":"rgba(129,140,248,0.06)",n=i?"rgba(248,113,113,0.25)":c?"rgba(251,191,36,0.25)":b?"rgba(52,211,153,0.25)":"rgba(129,140,248,0.25)",g=a>0?Math.min(t/a*100,100):0;return e.jsxs("div",{className:"db-daily-card db-daily-card-clickable",style:{background:C,borderColor:n},onClick:()=>{De(a>0?String(a):""),te(!0)},children:[e.jsxs("div",{className:"db-daily-card-left",children:[e.jsx("span",{className:"db-daily-card-label",children:"PENGELUARAN HARI INI"}),e.jsxs("span",{className:"db-daily-card-amount tabular",style:{color:h},children:["−",p(t)]})]}),e.jsx("div",{className:"db-daily-card-right",children:a>0?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"db-daily-card-track",children:e.jsx("div",{className:"db-daily-card-fill",style:{width:`${g}%`,background:h}})}),e.jsxs("span",{className:"db-daily-card-sub",style:{color:h},children:[i?"Melebihi":c?"Hampir":`${Math.round(g)}%`," dari ",p(a)]})]}):e.jsx("span",{className:"db-daily-card-sub",style:{color:"#818cf8"},children:"Atur budget harian →"})})]})})(),(()=>{var C;const a=s.categories.filter(n=>!U(n)&&!fe(n)&&n.is_monthly&&(n.budget_limit>0||(n.spent||0)>0)),t=s.categories.filter(n=>!U(n)&&!fe(n)&&!n.is_monthly&&(n.budget_limit>0||(n.spent||0)>0)),i=(s.hutangList||[]).filter(n=>n.jenis==="hutang"),c=(s.hutangList||[]).filter(n=>n.jenis==="piutang"),b=!v&&a.length===0&&t.length===0&&i.length===0&&c.length===0,h=({cat:n})=>{const g=n.budget_limit>0?n.spent/n.budget_limit*100:0,M=Math.min(g,100),x=g>100,z=!x&&g>=100,f=!x&&g>=80&&g<100,_=x?"var(--danger)":z?"var(--success)":f?"var(--warning)":n.color||"var(--accent)",W=n.budget_limit-(n.spent||0),O=s.salary>0&&n.budget_limit>0?Math.round(n.budget_limit/s.salary*100):null,Te=n.budget_limit>0;return e.jsxs("div",{className:`brow${!Te&&n.spent>0?" brow-no-budget":""}`,children:[e.jsxs("div",{className:"brow-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${n.color||"#6366f1"}18`},children:e.jsx("span",{style:{width:10,height:10,borderRadius:"50%",background:n.color||"var(--accent)",display:"inline-block",flexShrink:0}})}),e.jsxs("div",{style:{minWidth:0},children:[e.jsx("span",{className:"brow-name",children:n.name}),x&&e.jsx("span",{className:"badge badge-danger",style:{fontSize:"0.6rem",padding:"2px 6px",marginLeft:6},children:"Over"}),z&&e.jsx("span",{className:"badge badge-success",style:{fontSize:"0.6rem",padding:"2px 6px",marginLeft:6},children:"Penuh"}),f&&e.jsx("span",{className:"badge badge-warning",style:{fontSize:"0.6rem",padding:"2px 6px",marginLeft:6},children:"Hampir"})]})]}),n.budget_limit>0?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"brow-bar-wrap",children:e.jsx("div",{className:"brow-bar",children:e.jsx("div",{className:"brow-bar-fill",style:{width:`${M}%`,background:_}})})}),e.jsxs("div",{className:"brow-right",onClick:()=>O&&Ba(be=>!be),style:{cursor:O?"pointer":"default"},children:[e.jsx("span",{className:"brow-spent tabular",style:{color:x?"var(--danger)":"var(--text-primary)"},children:p(n.spent||0)}),Pa&&O?e.jsxs("span",{className:"brow-limit tabular",style:{color:"var(--accent)"},children:[O,"% gaji"]}):e.jsx("span",{className:"brow-limit tabular",style:{color:W<0?"var(--danger)":W===0?"var(--text-muted)":"var(--success)"},children:W<0?`Over ${p(Math.abs(W))}`:`Sisa ${p(W)}`})]}),e.jsxs("span",{className:"brow-pct",style:{color:_},children:[g.toFixed(0),"%"]})]}):n.spent>0?e.jsxs("span",{className:"brow-only-spent tabular",style:{color:"var(--danger)"},children:["−",p(n.spent)]}):null]})};return e.jsxs(e.Fragment,{children:[!v&&$.length>0&&e.jsxs("div",{className:"db-alert",children:[e.jsx(Za,{size:11}),e.jsxs("span",{children:["Overbudget — ",e.jsx("strong",{children:(C=$[_e])==null?void 0:C.name})]}),$.length>1&&e.jsxs("span",{className:"db-alert-count",children:[_e+1,"/",$.length]})]},_e),e.jsxs("div",{className:"card dash-tab-card",children:[e.jsxs("div",{className:"sect-head",style:{marginBottom:16},children:[e.jsxs("div",{className:"dash-tab-toggle",children:[e.jsx("button",{className:`dash-tab-btn${ce==="transaction"?" active":""}`,onClick:()=>Re("transaction"),children:"My Transaction"}),e.jsx("button",{className:`dash-tab-btn${ce==="budget"?" active":""}`,onClick:()=>Re("budget"),children:"My Budget"})]}),e.jsxs("div",{className:"tab-actions",children:[e.jsxs(Y,{to:`/transactions?month=${o}`,className:"tab-act",children:[e.jsx(xe,{size:13}),e.jsx("span",{className:"tab-act-label",children:"Lihat semua"})]}),e.jsxs(Y,{to:`/categories?month=${o}`,className:"tab-act",children:[e.jsx(ga,{size:13}),e.jsx("span",{className:"tab-act-label",children:"Atur"})]}),e.jsxs("button",{className:"tab-act tab-act-accent",onClick:()=>H(!0),children:[e.jsx(pa,{size:13}),e.jsx("span",{className:"tab-act-label",children:"Transaksi"})]})]})]}),e.jsxs("div",{className:"card-scroll-body",children:[ce==="transaction"&&(v?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[...Array(4)].map((n,g)=>e.jsx("div",{className:"skeleton",style:{height:42}},g))}):s.transactions.length===0?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:e.jsx(ba,{size:13})}),e.jsx("span",{children:"Belum ada transaksi bulan ini."}),e.jsx("button",{className:"empty-hint-link",onClick:()=>H(!0),children:"Tambah sekarang →"})]}):e.jsx("div",{className:"tx-list",children:s.transactions.map(n=>{var g;return e.jsxs("div",{className:"tx-row",children:[e.jsx("div",{className:"tx-icon",style:{background:n.type==="income"?"rgba(52,211,153,0.12)":"rgba(248,113,113,0.12)",color:n.type==="income"?"var(--success)":"var(--danger)"},children:n.type==="income"?e.jsx(ba,{size:14}):e.jsx(ne,{size:14})}),e.jsxs("div",{className:"tx-meta",children:[e.jsx("span",{className:"tx-desc",children:n.description||((g=n.categories)==null?void 0:g.name)||"Transaksi"}),e.jsx("span",{className:"tx-date",children:new Date(n.date).toLocaleDateString("id-ID",{day:"numeric",month:"short"})})]}),e.jsxs("span",{className:`tx-amount tabular ${n.type==="income"?"inc":"exp"}`,children:[n.type==="income"?"+":"−",p(n.amount)]})]},n.id)})})),ce==="budget"&&(v?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:[...Array(3)].map((n,g)=>e.jsx("div",{className:"skeleton",style:{height:44}},g))}):b?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:e.jsx(ga,{size:14})}),e.jsx("span",{children:"Tambahkan kategori dan budget"}),e.jsx(Y,{to:`/categories?month=${o}`,className:"empty-hint-link",style:{color:"var(--accent)"},children:"Atur →"})]}):e.jsxs(e.Fragment,{children:[(i.length>0||c.length>0)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"budget-section-label",children:"Hutang & Piutang"}),e.jsx("div",{className:"budget-rows",children:[...i,...c].map(n=>{const g=n.jenis==="piutang",M=g?"#f59e0b":"#f87171",x=new Date;x.setHours(0,0,0,0);const z=n.due_date?new Date(n.due_date):null,f=z?Math.round((z-x)/864e5):null,_=f!==null&&f<0;return e.jsxs("div",{className:"brow",children:[e.jsxs("div",{className:"brow-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${M}18`,color:M},children:g?e.jsx(ua,{size:13}):e.jsx(xe,{size:13})}),e.jsxs("div",{style:{minWidth:0},children:[e.jsx("span",{className:"brow-name",children:n.nama}),e.jsx("span",{style:{fontSize:"0.62rem",color:"var(--text-muted)",marginLeft:6},children:g?"piutang":"hutang"}),_&&e.jsx("span",{className:"badge badge-danger",style:{fontSize:"0.6rem",padding:"2px 6px",marginLeft:6},children:"Terlambat"})]})]}),e.jsx("div",{style:{flex:1}}),e.jsxs("div",{className:"brow-right",children:[e.jsx("span",{className:"brow-spent tabular",style:{color:M},children:p(n.amount)}),n.due_date&&e.jsx("span",{className:"brow-limit tabular",style:{color:_?"var(--danger)":f<=7?"var(--warning)":"var(--text-muted)"},children:f===0?"Hari ini":f>0?`${f}h lagi`:`${Math.abs(f)}h lalu`})]})]},n.id)})})]}),(i.length>0||c.length>0)&&a.length>0&&e.jsx("div",{style:{height:1,background:"var(--border)",margin:"12px 0"}}),a.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"budget-section-label",children:"Pengeluaran Rutin"}),e.jsx("div",{className:"budget-rows",children:a.map(n=>e.jsx(h,{cat:n},n.id))})]}),(a.length>0||i.length>0||c.length>0)&&t.length>0&&e.jsx("div",{style:{height:1,background:"var(--border)",margin:"12px 0"}}),t.length>0?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"budget-section-label",children:"Kategori Lainnya"}),e.jsx("div",{className:"budget-rows",children:t.map(n=>e.jsx(h,{cat:n},n.id))})]}):i.length===0&&c.length===0&&a.length===0&&e.jsxs("div",{style:{fontSize:"0.72rem",color:"var(--text-muted)"},children:["Belum ada kategori dengan budget. ",e.jsx(Y,{to:`/categories?month=${o}`,style:{color:"var(--accent)"},children:"Atur →"})]})]}))]})]})]})})()]}),Ca&&(()=>{const a=s.salary>0,t=async()=>{const i=parseFloat(A.amount.replace(/\D/g,""))||0;if(i){We(!0);try{const c=A.date||`${o}-01`;if(s.gajiTx){const{error:b}=await u.from("transactions").update({amount:i,description:A.note,date:c}).eq("id",s.gajiTx.id);if(b)throw b}else{const{error:b}=await u.from("transactions").insert({user_id:d.id,category_id:s.gajiCatId,type:"income",amount:i,description:A.note,date:c});if(b)throw b}j("Pemasukan disimpan","success"),V(!1),L()}catch(c){j(c.message,"error")}finally{We(!1)}}};return e.jsx("div",{className:"modal-overlay",onClick:()=>V(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:380},onClick:i=>i.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"modal-title",children:["Pemasukan Bulanan ",B(o)]}),e.jsx("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:a?"Edit jumlah atau catatan":"Catat pemasukan bulan ini"})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>V(!1),children:e.jsx(y,{size:16})})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Jumlah Pemasukan"}),e.jsx(ha,{value:A.amount,onChange:i=>de(c=>({...c,amount:i})),autoFocus:!0})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Tanggal Diterima"}),e.jsx("input",{className:"form-input",type:"date",value:A.date,min:`${o}-01`,max:(()=>{const[i,c]=o.split("-").map(Number);return new Date(i,c,0).toISOString().split("T")[0]})(),onChange:i=>de(c=>({...c,date:i.target.value}))})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:["Catatan ",!a&&e.jsx("span",{style:{color:"var(--text-muted)",fontWeight:400},children:"(opsional)"})]}),e.jsx("textarea",{className:"form-input",rows:2,placeholder:"Misal: gaji pokok + bonus, tunjangan, dll...",value:A.note,onChange:i=>de(c=>({...c,note:i.target.value})),style:{resize:"vertical",fontFamily:"var(--font-sans)",fontSize:"0.875rem"}})]}),e.jsxs("div",{className:"flex gap-8 mt-16",children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>V(!1),children:"Batal"}),e.jsx("button",{className:"btn btn-primary",style:{flex:1},onClick:t,disabled:$e||!A.amount,children:$e?"Menyimpan...":"Simpan"})]})]})})})(),za&&e.jsx("div",{className:"modal-overlay",onClick:()=>we(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:400},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Total Tabungan"}),e.jsxs("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:["Akumulasi s/d ",B(o)]})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>we(!1),children:e.jsx(y,{size:16})})]}),e.jsxs("div",{className:"wajib-rows",children:[(d.tabungan_awal||0)>0&&e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:"rgba(52,211,153,0.12)",color:"var(--success)",fontSize:"0.55rem",fontWeight:800},children:"AWAL"}),e.jsxs("div",{children:[e.jsx("div",{className:"brow-name",children:"Saldo Awal Tabungan"}),e.jsx("div",{style:{fontSize:"0.65rem",color:"var(--text-muted)"},children:"sebelum mulai record"})]})]}),e.jsx("span",{className:"wajib-amount tabular",style:{color:"var(--success)"},children:p(d.tabungan_awal)})]}),s.tabunganPerMonth.length===0&&!(d.tabungan_awal>0)?e.jsx("div",{style:{fontSize:"0.75rem",color:"var(--text-muted)",padding:"8px 0"},children:'Belum ada alokasi tabungan. Set budget kategori "Tabungan Bulanan".'}):s.tabunganPerMonth.map(a=>e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:"rgba(52,211,153,0.12)",color:"var(--success)"},children:e.jsx(ne,{size:13})}),e.jsxs("div",{children:[e.jsx("div",{className:"brow-name",children:B(a.month)}),e.jsx("div",{style:{fontSize:"0.65rem",color:"var(--text-muted)"},children:"Tabungan Bulanan"})]})]}),e.jsxs("span",{className:"wajib-amount tabular",style:{color:Number(a.budget_limit)>0?"var(--success)":"var(--text-muted)"},children:["+",p(a.budget_limit)]})]},a.month)),s.hutangTabunganList.filter(a=>!a.lunas).length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"wajib-divider",style:{margin:"8px 0"}}),e.jsx("div",{style:{fontSize:"0.62rem",fontWeight:700,textTransform:"uppercase",letterSpacing:"0.06em",color:"var(--text-muted)",marginBottom:4},children:"Outstanding bulan ini"}),s.hutangTabunganList.filter(a=>!a.lunas).map(a=>e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:a.jenis==="piutang"?"rgba(245,158,11,0.1)":"rgba(248,113,113,0.1)",color:a.jenis==="piutang"?"var(--warning)":"var(--danger)",fontSize:"0.9rem"},children:a.jenis==="piutang"?e.jsx(ua,{size:13}):e.jsx(xe,{size:13})}),e.jsxs("div",{children:[e.jsx("div",{className:"brow-name",children:a.nama}),e.jsx("div",{style:{fontSize:"0.62rem",color:"var(--text-muted)"},children:a.jenis==="hutang"?"Hutang":"Piutang"})]})]}),e.jsxs("span",{className:"wajib-amount tabular",style:{color:"var(--danger)"},children:["−",p(a.amount)]})]},a.id))]}),e.jsx("div",{className:"wajib-divider",style:{margin:"10px 0"}}),e.jsxs("div",{className:"wajib-row",style:{paddingTop:4},children:[e.jsx("span",{style:{fontSize:"0.78rem",fontWeight:700,color:"var(--text-primary)"},children:"Total Tabungan"}),e.jsx("span",{className:"wajib-amount tabular",style:{color:s.totalTabungan>0?"var(--success)":"var(--text-muted)",fontWeight:800},children:p(s.totalTabungan)})]})]})]})}),_a&&e.jsx("div",{className:"modal-overlay",onClick:()=>q(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:400},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Rencana Bulan Depan"}),e.jsx("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:B(je(o))})]}),e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsx(Y,{to:"/savings",className:"btn btn-ghost btn-sm",style:{fontSize:"0.72rem"},onClick:()=>q(!1),children:"Kelola →"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>q(!1),children:e.jsx(y,{size:16})})]})]}),s.nextMonthPlans.length===0?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:e.jsx(xe,{size:13})}),e.jsxs("span",{children:["Belum ada rencana untuk ",B(je(o)),"."]}),e.jsx(Y,{to:"/savings",className:"empty-hint-link",onClick:()=>q(!1),children:"Tambah →"})]}):e.jsxs("div",{className:"wajib-rows",children:[s.nextMonthPlans.map(a=>e.jsxs("div",{className:"wajib-row",children:[e.jsx("span",{className:"brow-name",children:a.name}),e.jsx("span",{className:"wajib-amount tabular",children:p(a.amount)})]},a.id)),e.jsx("div",{className:"wajib-divider"}),e.jsxs("div",{className:"wajib-row",style:{paddingTop:10},children:[e.jsx("span",{style:{fontSize:"0.78rem",fontWeight:700,color:"var(--text-primary)"},children:"Total"}),e.jsx("span",{className:"wajib-amount tabular",children:p(s.nextMonthPlans.reduce((a,t)=>a+Number(t.amount),0))})]})]})]})}),Ta&&e.jsx("div",{className:"modal-overlay",onClick:()=>{oe(!1),Z(null),F(null)},children:e.jsxs("div",{className:"modal",style:{maxWidth:380},onClick:a=>a.stopPropagation(),children:[!w&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h2",{className:"modal-title",children:"Detail Pinjaman"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>oe(!1),children:e.jsx(y,{size:16})})]}),e.jsxs("div",{className:"wajib-rows",children:[(s.hutangList||[]).filter(a=>a.jenis==="hutang").map(a=>e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:"rgba(251,191,36,0.1)",color:"#fbbf24"},children:e.jsx(ne,{size:13})}),e.jsx("span",{className:"brow-name",children:a.nama})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10},children:[e.jsx("span",{className:"wajib-amount tabular",children:p(Number(a.amount))}),e.jsx("button",{className:"btn btn-sm",style:{fontSize:"0.65rem",padding:"3px 10px",background:"rgba(52,211,153,0.12)",color:"#34d399",border:"1px solid rgba(52,211,153,0.25)",borderRadius:99},onClick:()=>{Z(a),F(null),ae(null)},children:"Bayar"})]})]},a.id)),e.jsx("div",{className:"wajib-divider"}),e.jsxs("div",{className:"wajib-row",style:{paddingTop:10},children:[e.jsx("span",{style:{fontSize:"0.78rem",fontWeight:700,color:"var(--text-primary)"},children:"Total Pinjaman"}),e.jsxs("span",{className:"wajib-amount tabular",style:{color:"#fbbf24"},children:["−",p(K)]})]})]})]}),w&&!E&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Hutang Terbayar"}),e.jsxs("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:[w.nama," · ",p(w.amount)]})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>Z(null),children:e.jsx(y,{size:16})})]}),e.jsx("p",{style:{fontSize:"0.78rem",color:"var(--text-muted)",marginBottom:14},children:"Bayar dari mana?"}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[e.jsxs("button",{className:"btn btn-secondary",style:{justifyContent:"flex-start",gap:10},onClick:()=>F("tabungan"),children:[e.jsx("span",{style:{fontSize:"1rem"},children:"🏦"}),e.jsxs("div",{style:{textAlign:"left"},children:[e.jsx("div",{style:{fontWeight:700,fontSize:"0.82rem"},children:"Tabungan"}),e.jsx("div",{style:{fontSize:"0.65rem",color:"var(--text-muted)",fontWeight:400},children:"Kurangi dari kantong tabungan"})]})]}),e.jsxs("button",{className:"btn btn-secondary",style:{justifyContent:"flex-start",gap:10},onClick:()=>F("saldo"),children:[e.jsx("span",{style:{fontSize:"1rem"},children:"💳"}),e.jsxs("div",{style:{textAlign:"left"},children:[e.jsx("div",{style:{fontWeight:700,fontSize:"0.82rem"},children:"Saldo"}),e.jsx("div",{style:{fontSize:"0.65rem",color:"var(--text-muted)",fontWeight:400},children:"Bayar langsung dari saldo"})]})]})]})]}),w&&E==="tabungan"&&!ee&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Pilih Tabungan"}),e.jsxs("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:[p(w.amount)," akan dikurangi"]})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>F(null),children:e.jsx(y,{size:16})})]}),e.jsx("div",{className:"wajib-rows",children:(s.savings||[]).map(a=>e.jsxs("div",{className:"wajib-row",style:{cursor:"pointer"},onClick:()=>ae(a.id),children:[e.jsx("span",{className:"brow-name",children:a.name}),e.jsx("span",{className:"wajib-amount tabular",style:{color:Number(a.current_amount)>=Number(w.amount)?"#34d399":"#f87171"},children:p(Number(a.current_amount))})]},a.id))})]}),w&&E&&(E==="saldo"||ee)&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("div",{children:e.jsx("h2",{className:"modal-title",children:"Konfirmasi"})}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>{E==="saldo"?F(null):ae(null)},children:e.jsx(y,{size:16})})]}),e.jsxs("div",{style:{fontSize:"0.82rem",color:"var(--text-muted)",lineHeight:1.6,marginBottom:16},children:["Tandai hutang ke ",e.jsx("strong",{style:{color:"var(--text-primary)"},children:w.nama})," sebesar"," ",e.jsx("strong",{style:{color:"#fbbf24"},children:p(w.amount)})," sebagai ",e.jsx("strong",{style:{color:"#34d399"},children:"lunas"}),E==="tabungan"&&e.jsxs(e.Fragment,{children:[" dari tabungan ",e.jsx("strong",{style:{color:"var(--text-primary)"},children:(ra=(s.savings||[]).find(a=>a.id===ee))==null?void 0:ra.name})]}),"?"]}),e.jsxs("div",{style:{display:"flex",gap:8,justifyContent:"flex-end"},children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>{Z(null),F(null),ae(null)},children:"Batal"}),e.jsx("button",{className:"btn btn-primary",disabled:Fe,onClick:async()=>{Ae(!0);try{if(E==="tabungan"){const a=(s.savings||[]).find(t=>t.id===ee);await u.from("savings").update({current_amount:Number(a.current_amount)-Number(w.amount)}).eq("id",ee)}await u.from("hutang").update({lunas:!0}).eq("id",w.id),await L(),oe(!1),Z(null),F(null),ae(null)}finally{Ae(!1)}},children:Fe?"Menyimpan...":"Konfirmasi Lunas"})]})]})]})}),Ma&&e.jsx("div",{className:"modal-overlay",onClick:()=>te(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:340},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Budget Harian"}),e.jsx("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:"Batas pengeluaran per hari"})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>te(!1),children:e.jsx(y,{size:16})})]}),e.jsxs("div",{style:{padding:"4px 0 8px"},children:[e.jsx("label",{style:{fontSize:"0.72rem",color:"var(--text-muted)",display:"block",marginBottom:6},children:"Jumlah per hari"}),e.jsx("input",{className:"form-input",type:"number",placeholder:"cth: 50000",value:Ne,onChange:a=>De(a.target.value),autoFocus:!0})]}),e.jsxs("div",{style:{display:"flex",gap:8,justifyContent:"flex-end",marginTop:8},children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>te(!1),children:"Batal"}),e.jsx("button",{className:"btn btn-primary",disabled:Ee||!Ne,onClick:async()=>{Le(!0);try{await J({budget_harian:parseFloat(Ne)||0}),te(!1)}finally{Le(!1)}},children:Ee?"Menyimpan...":"Simpan"})]})]})}),Sa&&e.jsx("div",{className:"modal-overlay",onClick:()=>le(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:420},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Pengeluaran Tetap"}),e.jsx("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:B(o)})]}),e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsx("button",{className:"btn btn-ghost btn-sm",style:{fontSize:"0.72rem"},onClick:()=>{le(!1),ve(!0)},children:"Kelola"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>le(!1),children:e.jsx(y,{size:16})})]})]}),e.jsxs("div",{className:"wajib-rows",children:[s.categories.filter(a=>U(a)).map(a=>{const t=Number(a.budget_limit||0),i=s.salary>0&&t>0?Math.round(t/s.salary*100):null;return e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:"rgba(248,113,113,0.12)",color:"var(--danger)"},children:e.jsx(ne,{size:13})}),e.jsx("span",{className:"brow-name",children:a.name})]}),e.jsxs("div",{className:"wajib-right",children:[i&&e.jsxs("span",{className:"wajib-pct",children:[i,"%"]}),e.jsx("span",{className:"wajib-amount tabular",children:t>0?p(t):"—"})]})]},a.id)}),e.jsx("div",{className:"wajib-divider"}),e.jsxs("div",{className:"wajib-row",style:{paddingTop:10},children:[e.jsx("span",{style:{fontSize:"0.78rem",fontWeight:700,color:"var(--text-primary)"},children:"Total Potongan"}),e.jsxs("span",{className:"wajib-amount tabular",style:{color:"var(--danger)"},children:["−",p(Ge)]})]})]})]})}),wa&&e.jsx("div",{className:"modal-overlay",onClick:()=>H(!1),children:e.jsxs("div",{className:"modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h2",{className:"modal-title",children:"Tambah Transaksi"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>H(!1),children:e.jsx(y,{size:16})})]}),e.jsx(et,{month:o,onSuccess:()=>{L(),H(!1)},onClose:()=>H(!1)})]})}),Na&&!k&&!Ie&&e.jsx("div",{className:"modal-overlay",onClick:()=>ve(!1),children:e.jsxs("div",{className:"modal cat-manager-modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Kelola Kategori"}),e.jsx("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:B(o)})]}),e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsxs("button",{className:"btn btn-primary btn-sm",onClick:()=>{ka({is_mandatory:!0}),Q(!0)},children:[e.jsx(pa,{size:13})," Kategori"]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>ve(!1),children:e.jsx(y,{size:16})})]})]}),e.jsxs("div",{style:{marginBottom:20},children:[e.jsx("p",{className:"cat-mgr-section-title",children:"Pengeluaran Wajib"}),e.jsx("div",{style:{display:"flex",flexDirection:"column"},children:s.categories.filter(a=>U(a)).map(a=>{const t=Number(a.budget_limit)||0,i=s.salary>0&&t>0?Math.round(t/s.salary*100):null;return e.jsxs("div",{className:"cat-mgr-row",children:[e.jsxs("div",{className:"cat-mgr-left",children:[e.jsx("span",{className:"cat-mgr-icon",style:{background:"rgba(248,113,113,0.12)",color:"var(--danger)"},children:e.jsx(ne,{size:14})}),e.jsxs("div",{children:[e.jsx("span",{className:"cat-mgr-name",children:a.name}),e.jsx("span",{className:"cat-mgr-sub",children:"Wajib · langsung dipotong"})]})]}),e.jsxs("div",{className:"cat-mgr-right",children:[i&&e.jsxs("span",{className:"cat-mgr-pct",children:[i,"%"]}),e.jsx("span",{className:"cat-mgr-amount tabular",children:t>0?p(t):"—"}),e.jsx("button",{className:"btn btn-ghost btn-sm",style:{fontSize:"0.7rem"},onClick:()=>Aa(a),children:"Ubah"})]})]},a.id)})})]})]})}),k&&(()=>{const a=s.categories.find(t=>t.id===k.id);return e.jsx("div",{className:"modal-overlay",onClick:()=>I(null),children:e.jsxs("div",{className:"modal",style:{maxWidth:380},onClick:t=>t.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"modal-title",children:["Pengeluaran Wajib — ",a==null?void 0:a.name]}),e.jsxs("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:[B(o),s.salary>0?` · ${p(s.salary)}`:""]})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>I(null),children:e.jsx(y,{size:16})})]}),s.salary>0&&e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Persentase dari gaji"}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[e.jsxs("div",{style:{position:"relative",flex:1},children:[e.jsx("input",{className:"form-input",type:"number",placeholder:String(it),value:k.pct,onChange:t=>Oe(t.target.value),min:"0",max:"100",step:"0.5",style:{paddingRight:36}}),e.jsx("span",{style:{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",color:"var(--text-muted)",fontWeight:700,fontSize:"0.85rem"},children:"%"})]}),k.pct&&s.salary>0&&e.jsxs("span",{style:{fontSize:"0.78rem",color:"var(--text-secondary)",fontWeight:600,whiteSpace:"nowrap"},children:["= ",p(Math.round(parseFloat(k.pct)/100*s.salary))]})]}),!k.pct&&e.jsx("div",{style:{display:"flex",gap:6,marginTop:6,flexWrap:"wrap"},children:[10,15,20,25].map(t=>e.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>Oe(String(t)),children:[t,"%"]},t))})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Atau nominal langsung"}),e.jsx(ha,{value:k.nominal,onChange:Da,autoFocus:!s.salary})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:16},children:[e.jsx("button",{className:"btn btn-ghost btn-sm",style:{color:"var(--danger)",fontSize:"0.78rem"},onClick:()=>{I(null),ye({id:a.id,name:a.name})},children:"Hapus Kategori"}),e.jsxs("div",{className:"flex gap-8",children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>I(null),children:"Batal"}),e.jsx("button",{className:"btn btn-primary",onClick:Ea,children:"Simpan"})]})]})]})})})(),X&&e.jsx(nt,{title:"Hapus Kategori",message:`Hapus kategori "${X.name}"? Semua transaksi kategori ini juga akan terhapus.`,confirmLabel:"Hapus",onConfirm:La,onCancel:()=>ye(null)}),Ie&&e.jsx("div",{className:"modal-overlay",onClick:()=>Q(!1),children:e.jsxs("div",{className:"modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h2",{className:"modal-title",children:ie!=null&&ie.id?"Edit Kategori":"Kategori Baru"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>Q(!1),children:e.jsx(y,{size:16})})]}),e.jsx(at,{editData:ie,salary:s.salary,month:o,onSuccess:()=>{L(),Q(!1)},onClose:()=>Q(!1)})]})}),e.jsx("style",{children:`
        /* ── Month Picker Popup ───────────────── */
