import{F as _a,H as Sa,K as Ca,J as Ta,D as g,w as X,B as e,z as S,G as Ma,y as Ze,A as Pa,E as u,v as p,f as Ba,I as Ia,L as G,d as ie,n as ea,m as aa,c as ta,a as oe,b as sa,s as I,C as ra}from"./index-BLpsvlZG.js";import{T as Aa}from"./TransactionForm-CvWP0_cs.js";import{C as Da}from"./CategoryForm-YdjIEsTh.js";import{a as le,d as Ne,i as Y,f as Fa,c as Ea,e as $a,C as La}from"./ConfirmModal-Ct2mL1y7.js";const Wa=15;function qa(d){const[L,v]=d.split("-").map(Number),A=new Date(L,v-2,1);return`${A.getFullYear()}-${String(A.getMonth()+1).padStart(2,"0")}`}function de(d){const[L,v]=d.split("-").map(Number),A=new Date(L,v,1);return`${A.getFullYear()}-${String(A.getMonth()+1).padStart(2,"0")}`}function Ga(){var Le,We,qe,Re,He,Ke,Oe,Ge;const{user:d}=_a(),{setHeader:L}=Sa(),v=Ca(),[A,na]=Ta(),[l,ia]=g.useState(()=>A.get("month")||X()),[s,oa]=g.useState({salary:0,totalExpense:0,totalIncome:0,categories:[],transactions:[],savings:[],savingsLogs:[],categorySpend:[],hutangList:[],hutangTabunganList:[],todayExpense:0,totalTabungan:0,tabunganPerMonth:[],nextMonthPlans:[],cumulativeBalance:0,cumulativeMandatoryBudget:0,gajiTx:null,gajiCatId:null}),[f,ke]=g.useState(!0),[la,W]=g.useState(!1),[da,ce]=g.useState(!1),[j,C]=g.useState(null),[ze,U]=g.useState(!1),[V,ca]=g.useState(null),[J,me]=g.useState(null),[ma,Z]=g.useState(!1),[ga,ge]=g.useState(!1),[pa,q]=g.useState(!1),[ba,Q]=g.useState(!1),[T,ee]=g.useState({amount:"",note:"",date:""}),[_e,Se]=g.useState(!1),[pe,be]=g.useState(!1),[k,ue]=g.useState(()=>Number(X().split("-")[0])),[ua,ha]=g.useState(!1),[ae,Ce]=g.useState("transaction"),[he,Te]=g.useState(0),[R,Me]=g.useState(0),[D,Pe]=g.useState(0);g.useEffect(()=>{if(d.recording_start_month&&l<d.recording_start_month){te(d.recording_start_month);return}H()},[l,d==null?void 0:d.recording_start_month]),g.useEffect(()=>{const a=l===X(),t=!!d.recording_start_month&&l<=d.recording_start_month,[i,c]=d.recording_start_month?d.recording_start_month.split("-").map(Number):[0,0],b=X(),[N,P]=b.split("-").map(Number),n=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Ags","Sep","Okt","Nov","Des"];return L(e.jsxs(e.Fragment,{children:[pe&&e.jsx("div",{style:{position:"fixed",inset:0,zIndex:299},onClick:()=>be(!1)}),e.jsxs("div",{className:"month-nav-group",children:[e.jsx("button",{className:"month-btn",onClick:()=>te(qa(l)),disabled:t,children:"‹"}),e.jsx("span",{className:"month-label-text month-label-clickable",onClick:()=>{ue(Number(l.split("-")[0])),be(m=>!m)},children:S(l)}),e.jsx("button",{className:"month-btn",onClick:()=>te(de(l)),disabled:a,children:"›"}),pe&&e.jsxs("div",{className:"month-picker-popup",onMouseDown:m=>m.preventDefault(),children:[e.jsxs("div",{className:"mp-year-row",children:[e.jsx("button",{className:"mp-year-btn",onClick:()=>ue(m=>m-1),disabled:!!d.recording_start_month&&k<=i,children:"‹"}),e.jsx("span",{className:"mp-year-label",children:k}),e.jsx("button",{className:"mp-year-btn",onClick:()=>ue(m=>m+1),disabled:k>=N,children:"›"})]}),e.jsx("div",{className:"mp-grid",children:n.map((m,z)=>{const h=z+1,y=`${k}-${String(h).padStart(2,"0")}`,x=k>N||k===N&&h>P,w=!!d.recording_start_month&&(k<i||k===i&&h<c);return e.jsx("button",{className:`mp-month-btn${y===l?" mp-active":""}`,disabled:x||w,onClick:()=>{te(y),be(!1)},children:m},y)})})]})]})]})),()=>L(null)},[l,pe,k,d==null?void 0:d.recording_start_month]),Ma();const te=a=>{ia(a),na({month:a})},H=async()=>{ke(!0);try{const a=`${l}-01`,t=Ze(l),i=Pa(),c=de(l),b=d.recording_start_month;let N=u.from("transactions").select("amount, type").eq("user_id",d.id).lt("date",a);b&&(N=N.gte("date",`${b}-01`));let P=u.from("category_budgets").select("budget_limit, category_id, month, categories(is_mandatory, name, category_type)").eq("user_id",d.id).lte("month",l);b&&(P=P.gte("month",b));const[n,m,z,h,y,x,w,$,K,je,se]=await Promise.all([u.from("transactions").select("*, categories(name, color, icon)").eq("user_id",d.id).gte("date",a).lte("date",t).order("date",{ascending:!1}),Promise.all([u.from("categories").select("*").eq("user_id",d.id).is("month",null),u.from("categories").select("*").eq("user_id",d.id).eq("month",l)]).then(([r,o])=>{const _=[...r.data||[],...o.data||[]].sort((ne,za)=>ne.name.localeCompare(za.name)),Ve=new Set;return{data:_.filter(ne=>Ve.has(ne.name)?!1:(Ve.add(ne.name),!0))}}),u.from("savings").select("*").eq("user_id",d.id),u.from("savings_log").select("*").eq("user_id",d.id).eq("month",l),u.from("transactions").select("amount").eq("user_id",d.id).eq("date",i).eq("type","expense"),u.from("category_budgets").select("category_id, budget_limit").eq("user_id",d.id).eq("month",l),P,u.from("plans").select("*").eq("user_id",d.id).eq("target_month",c).eq("done",!1).order("created_at",{ascending:!0}),N,u.from("hutang").select("id, nama, amount, due_date, sumber, jenis, lunas").eq("user_id",d.id).lte("month",l).eq("lunas",!1).order("due_date",{ascending:!0,nullsFirst:!1}),u.from("hutang").select("id, nama, amount, jenis, lunas, created_at").eq("user_id",d.id).lte("month",l).eq("sumber","tabungan").order("created_at",{ascending:!1})]),O=n.data||[],ye={};(x.data||[]).forEach(r=>{ye[r.category_id]=Number(r.budget_limit)});let Ye=(m.data||[]).map(r=>{const o=ye[r.id]!==void 0?ye[r.id]:0;return{...r,budget_limit:o,budget_set:o>0}});const B=Ye.find(r=>le(r)),Ue=B?O.filter(r=>r.type==="income"&&r.category_id===B.id):[],Je=Ue.reduce((r,o)=>r+Number(o.amount),0),Na=Ye,Qe=O.filter(r=>r.type==="expense").reduce((r,o)=>r+Number(o.amount),0),Xe=O.filter(r=>r.type==="income"&&r.category_id!==(B==null?void 0:B.id)).reduce((r,o)=>r+Number(o.amount),0),we={};O.filter(r=>r.type==="expense"&&r.category_id).forEach(r=>{we[r.category_id]=(we[r.category_id]||0)+Number(r.amount)});const re={};O.filter(r=>r.type==="expense"&&r.categories).forEach(r=>{const o=r.categories.name;re[o]||(re[o]={name:o,amount:0,color:r.categories.color,icon:r.categories.icon}),re[o].amount+=Number(r.amount)});const ka=Na.map(r=>{const o=we[r.id]||0,_=r.budget_limit>0?o/r.budget_limit*100:null;return{...r,spent:o,pct:_,overBudget:r.budget_limit>0&&o>r.budget_limit}}).sort((r,o)=>r.overBudget&&!o.overBudget?-1:!r.overBudget&&o.overBudget?1:(o.pct||0)-(r.pct||0));oa({salary:Je,totalExpense:Qe,totalIncome:Xe,categories:ka,transactions:O.slice(0,5),savings:z.data||[],savingsLogs:h.data||[],todayExpense:(y.data||[]).reduce((r,o)=>r+Number(o.amount),0),tabunganPerMonth:(w.data||[]).filter(r=>{var o,_;return(((o=r.categories)==null?void 0:o.category_type)==="savings"||((_=r.categories)==null?void 0:_.name)==="Tabungan Bulanan")&&Number(r.budget_limit)>0}).sort((r,o)=>r.month.localeCompare(o.month)),totalTabungan:(w.data||[]).filter(r=>{var o,_;return((o=r.categories)==null?void 0:o.category_type)==="savings"||((_=r.categories)==null?void 0:_.name)==="Tabungan Bulanan"}).reduce((r,o)=>r+Number(o.budget_limit),0)+(d.tabungan_awal||0)-(se.data||[]).filter(r=>!r.lunas).reduce((r,o)=>r+Number(o.amount),0),categorySpend:Object.values(re).sort((r,o)=>o.amount-r.amount),nextMonthPlans:$.data||[],gajiTx:Ue[0]||null,gajiCatId:(B==null?void 0:B.id)||null,hutangList:je.data||[],hutangTabunganList:se.data||[],cumulativeBalance:(K.data||[]).reduce((r,o)=>r+(o.type==="income"?Number(o.amount):-Number(o.amount)),0)+Je+Xe-Qe+(d.saldo_awal||0),cumulativeMandatoryBudget:(w.data||[]).filter(r=>{var o;return((o=r.categories)==null?void 0:o.is_mandatory)===!0}).reduce((r,o)=>r+Number(o.budget_limit),0)})}finally{ke(!1)}},xa=a=>{const t=String(Math.round(a.budget_limit||0)),i=s.salary>0&&a.budget_limit>0?(a.budget_limit/s.salary*100).toFixed(1):"";C({id:a.id,nominal:t,pct:i})},fa=a=>{const t=parseFloat(a)||0,i=s.salary>0&&t>0?(t/s.salary*100).toFixed(1):"";C(c=>({...c,nominal:a,pct:i}))},Be=a=>{const t=parseFloat(a)||0,i=s.salary>0&&t>0?String(Math.round(t/100*s.salary)):"";C(c=>({...c,pct:a,nominal:i}))},va=async()=>{const a=parseFloat(j.nominal)||0,[t,i]=await Promise.all([u.from("category_budgets").upsert({user_id:d.id,category_id:j.id,month:l,budget_limit:a},{onConflict:"category_id,month"}),u.from("categories").update({budget_limit:a}).eq("id",j.id)]),c=t.error||i.error;if(c){v(c.message,"error");return}v("Budget disimpan","success"),C(null),H()},ja=async()=>{const a=`${l}-01`,t=Ze(l),[i,c]=await Promise.all([u.from("transactions").delete().eq("category_id",J.id).gte("date",a).lte("date",t),u.from("category_budgets").delete().eq("category_id",J.id).eq("month",l)]);if(i.error||c.error){v((i.error||c.error).message,"error");return}const{error:b}=await u.from("categories").delete().eq("id",J.id);if(b){v(b.message,"error");return}v("Kategori dihapus","success"),me(null),H()};s.categories.filter(a=>a.budget_limit>0).reduce((a,t)=>a+t.budget_limit,0),X();const F=s.categories.filter(a=>a.overBudget);g.useEffect(()=>{if(F.length<=1){Te(0);return}const a=setInterval(()=>Te(t=>(t+1)%F.length),2e3);return()=>clearInterval(a)},[F.length]);const xe=s.categories.filter(a=>Ne(a)).length;g.useEffect(()=>{if(f||xe<=1)return;const a=setInterval(()=>Me(t=>(t+1)%xe),2500);return()=>clearInterval(a)},[f,xe]),g.useEffect(()=>{if(f)return;const a=setInterval(()=>Pe(t=>(t+1)%3),3e3);return()=>clearInterval(a)},[f]);const Ie=s.categories.filter(a=>Y(a)).reduce((a,t)=>a+Number(t.budget_limit||0),0),ya=s.categories.filter(a=>Y(a)).reduce((a,t)=>a+(t.spent||0),0),wa=Math.max(0,Ie-ya),Ae=s.totalExpense+wa;s.salary+s.totalIncome-Ae,s.salary>0&&Ae/s.salary*100;const fe=s.categories.filter(a=>Ne(a)&&a.budget_limit>0).reduce((a,t)=>a+Number(t.budget_limit),0);s.categories.filter(a=>le(a));const M=s.categories.filter(a=>Ne(a)),De=s.categories.filter(a=>Fa(a)),Fe=s.categories.filter(a=>Ea(a)),Ee=s.categories.filter(a=>$a(a)),E=[{label:"Wajib",spent:De.reduce((a,t)=>a+(t.spent||0),0),budget:De.reduce((a,t)=>a+Number(t.budget_limit||0),0),color:"#f87171",action:()=>Z(!0)},{label:"Rutin",spent:Fe.reduce((a,t)=>a+(t.spent||0),0),budget:Fe.reduce((a,t)=>a+Number(t.budget_limit||0),0),color:"#fbbf24"},{label:"Tambahan",spent:Ee.reduce((a,t)=>a+(t.spent||0),0),budget:Ee.reduce((a,t)=>a+Number(t.budget_limit||0),0),color:"#f97316"}],ve=s.cumulativeBalance-s.cumulativeMandatoryBudget;s.salary-s.totalExpense-fe,s.salary>0&&s.totalExpense/s.salary*100;const $e=s.salary>0?s.salary-fe:0;return $e-s.totalExpense,s.salary>0&&fe>0&&s.totalExpense>$e,e.jsxs("div",{className:"animate-in",children:[e.jsxs("div",{className:"db-page",children:[e.jsxs("div",{className:"db-hero",children:[e.jsx("span",{className:"db-eyebrow",children:"TOTAL SALDO"}),f?e.jsx("div",{className:"skeleton",style:{height:56,width:220,borderRadius:8,marginTop:6}}):e.jsxs("div",{className:`db-balance${ve<0?" neg":""}`,children:[ve<0&&e.jsx("span",{className:"db-neg-sign",children:"−"}),p(Math.abs(ve))]}),e.jsxs("div",{className:"db-hero-chips",children:[!f&&s.todayExpense>0&&e.jsx("div",{className:"db-daily",children:(()=>{const a=d.budget_harian||0,t=s.todayExpense,i=a>0&&t>=a,c=a>0&&t/a>=.8&&!i,b=i?"#f87171":c?"#fbbf24":"var(--text-primary)";return e.jsxs(e.Fragment,{children:[e.jsxs("span",{style:{color:b},children:["Hari ini −",p(t)]}),i&&e.jsx("span",{className:"db-daily-badge",style:{background:"rgba(248,113,113,0.1)",color:"#f87171"},children:"melebihi limit"}),c&&e.jsx("span",{className:"db-daily-badge",style:{background:"rgba(251,191,36,0.1)",color:"#fbbf24"},children:"hampir limit"})]})})()}),!f&&s.nextMonthPlans.length>0&&e.jsxs("button",{className:"db-rencana-chip",onClick:()=>q(!0),children:[e.jsx(Ba,{size:11}),s.nextMonthPlans.length," rencana bulan depan"]})]})]}),!f&&e.jsxs("div",{className:"db-stats-grid",children:[e.jsxs("button",{className:"db-stat db-stat-btn",onClick:()=>{var a,t;ee({amount:s.gajiTx?String(s.gajiTx.amount):"",note:((a=s.gajiTx)==null?void 0:a.description)||"",date:((t=s.gajiTx)==null?void 0:t.date)||`${l}-01`}),Q(!0)},children:[e.jsx("span",{className:"db-stat-label",children:"PEMASUKAN"}),e.jsx("span",{className:"db-stat-val tabular",style:{color:s.salary>0?"#34d399":"var(--text-muted)"},children:s.salary>0?`+${p(s.salary)}`:"—"}),e.jsx("span",{className:"db-stat-sub",children:s.salary>0?"bulan ini":"belum dicatat"})]}),e.jsxs("button",{className:"db-stat db-stat-btn",onClick:()=>ge(!0),children:[e.jsx("span",{className:"db-stat-label",children:"TABUNGAN"}),M.length>0?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"db-stat-val tabular",style:{color:(((Le=M[R])==null?void 0:Le.budget_limit)||0)>0?"#818cf8":"var(--text-muted)"},children:(((We=M[R])==null?void 0:We.budget_limit)||0)>0?p(M[R].budget_limit):"—"}),e.jsx("span",{className:"db-stat-sub",style:{color:(qe=M[R])==null?void 0:qe.color},children:((Re=M[R])==null?void 0:Re.name)||"—"})]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"db-stat-val tabular",style:{color:"var(--text-muted)"},children:"—"}),e.jsx("span",{className:"db-stat-sub",children:"belum diatur"})]}),M.length>1&&e.jsx("div",{className:"db-sub-dots",children:M.map((a,t)=>e.jsx("span",{className:`db-sub-dot${R===t?" active":""}`,onClick:i=>{i.stopPropagation(),Me(t)}},t))})]}),e.jsxs("button",{className:"db-stat db-stat-btn",onClick:()=>{var a,t;return(t=(a=E[D])==null?void 0:a.action)==null?void 0:t.call(a)},children:[e.jsx("span",{className:"db-stat-label",children:"PENGELUARAN"}),e.jsx("span",{className:"db-stat-val tabular",style:{color:(((He=E[D])==null?void 0:He.spent)||0)>0?"#f87171":"var(--text-muted)"},children:(((Ke=E[D])==null?void 0:Ke.spent)||0)>0?`−${p(E[D].spent)}`:"—"}),e.jsx("span",{className:"db-stat-sub",style:{color:(Oe=E[D])==null?void 0:Oe.color},children:(Ge=E[D])==null?void 0:Ge.label}),e.jsx("div",{className:"db-sub-dots",children:E.map((a,t)=>e.jsx("span",{className:`db-sub-dot${D===t?" active":""}`,onClick:i=>{i.stopPropagation(),Pe(t)}},t))})]}),e.jsxs("button",{className:"db-stat db-stat-btn",onClick:()=>q(!0),children:[e.jsx("span",{className:"db-stat-label",children:"RENCANA"}),e.jsx("span",{className:"db-stat-val tabular",style:{color:s.nextMonthPlans.length>0?"#fbbf24":"var(--text-muted)"},children:s.nextMonthPlans.length>0?s.nextMonthPlans.length:"—"}),e.jsx("span",{className:"db-stat-sub",children:s.nextMonthPlans.length>0?"rencana bulan depan":"belum ada rencana"})]})]}),f&&e.jsx("div",{className:"skeleton",style:{height:120,borderRadius:"var(--radius-lg)"}}),(()=>{var P;const a=s.categories.filter(n=>!Y(n)&&!le(n)&&n.is_monthly&&(n.budget_limit>0||(n.spent||0)>0)),t=s.categories.filter(n=>!Y(n)&&!le(n)&&!n.is_monthly&&(n.budget_limit>0||(n.spent||0)>0)),i=(s.hutangList||[]).filter(n=>n.jenis==="hutang"),c=(s.hutangList||[]).filter(n=>n.jenis==="piutang"),b=!f&&a.length===0&&t.length===0&&i.length===0&&c.length===0,N=({cat:n})=>{const m=n.budget_limit>0?n.spent/n.budget_limit*100:0,z=Math.min(m,100),h=m>100,y=!h&&m>=100,x=!h&&m>=80&&m<100,w=h?"var(--danger)":y?"var(--success)":x?"var(--warning)":n.color||"var(--accent)",$=n.budget_limit-(n.spent||0),K=s.salary>0&&n.budget_limit>0?Math.round(n.budget_limit/s.salary*100):null,je=n.budget_limit>0;return e.jsxs("div",{className:`brow${!je&&n.spent>0?" brow-no-budget":""}`,children:[e.jsxs("div",{className:"brow-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${n.color||"#6366f1"}18`},children:e.jsx("span",{style:{width:10,height:10,borderRadius:"50%",background:n.color||"var(--accent)",display:"inline-block",flexShrink:0}})}),e.jsxs("div",{style:{minWidth:0},children:[e.jsx("span",{className:"brow-name",children:n.name}),h&&e.jsx("span",{className:"badge badge-danger",style:{fontSize:"0.6rem",padding:"2px 6px",marginLeft:6},children:"Over"}),y&&e.jsx("span",{className:"badge badge-success",style:{fontSize:"0.6rem",padding:"2px 6px",marginLeft:6},children:"Penuh"}),x&&e.jsx("span",{className:"badge badge-warning",style:{fontSize:"0.6rem",padding:"2px 6px",marginLeft:6},children:"Hampir"})]})]}),n.budget_limit>0?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"brow-bar-wrap",children:e.jsx("div",{className:"brow-bar",children:e.jsx("div",{className:"brow-bar-fill",style:{width:`${z}%`,background:w}})})}),e.jsxs("div",{className:"brow-right",onClick:()=>K&&ha(se=>!se),style:{cursor:K?"pointer":"default"},children:[e.jsx("span",{className:"brow-spent tabular",style:{color:h?"var(--danger)":"var(--text-primary)"},children:p(n.spent||0)}),ua&&K?e.jsxs("span",{className:"brow-limit tabular",style:{color:"var(--accent)"},children:[K,"% gaji"]}):e.jsx("span",{className:"brow-limit tabular",style:{color:$<0?"var(--danger)":$===0?"var(--text-muted)":"var(--success)"},children:$<0?`Over ${p(Math.abs($))}`:`Sisa ${p($)}`})]}),e.jsxs("span",{className:"brow-pct",style:{color:w},children:[m.toFixed(0),"%"]})]}):n.spent>0?e.jsxs("span",{className:"brow-only-spent tabular",style:{color:"var(--danger)"},children:["−",p(n.spent)]}):null]})};return e.jsxs(e.Fragment,{children:[!f&&F.length>0&&e.jsxs("div",{className:"db-alert",children:[e.jsx(Ia,{size:11}),e.jsxs("span",{children:["Overbudget — ",e.jsx("strong",{children:(P=F[he])==null?void 0:P.name})]}),F.length>1&&e.jsxs("span",{className:"db-alert-count",children:[he+1,"/",F.length]})]},he),e.jsxs("div",{className:"card dash-tab-card",children:[e.jsxs("div",{className:"sect-head",style:{marginBottom:16},children:[e.jsxs("div",{className:"dash-tab-toggle",children:[e.jsx("button",{className:`dash-tab-btn${ae==="transaction"?" active":""}`,onClick:()=>Ce("transaction"),children:"My Transaction"}),e.jsx("button",{className:`dash-tab-btn${ae==="budget"?" active":""}`,onClick:()=>Ce("budget"),children:"My Budget"})]}),e.jsxs("div",{className:"tab-actions",children:[e.jsxs(G,{to:`/transactions?month=${l}`,className:"tab-act",children:[e.jsx(ie,{size:13}),e.jsx("span",{className:"tab-act-label",children:"Lihat semua"})]}),e.jsxs(G,{to:`/categories?month=${l}`,className:"tab-act",children:[e.jsx(ea,{size:13}),e.jsx("span",{className:"tab-act-label",children:"Atur"})]}),e.jsxs("button",{className:"tab-act tab-act-accent",onClick:()=>W(!0),children:[e.jsx(aa,{size:13}),e.jsx("span",{className:"tab-act-label",children:"Transaksi"})]})]})]}),e.jsxs("div",{className:"card-scroll-body",children:[ae==="transaction"&&(f?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[...Array(4)].map((n,m)=>e.jsx("div",{className:"skeleton",style:{height:42}},m))}):s.transactions.length===0?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:e.jsx(ta,{size:13})}),e.jsx("span",{children:"Belum ada transaksi bulan ini."}),e.jsx("button",{className:"empty-hint-link",onClick:()=>W(!0),children:"Tambah sekarang →"})]}):e.jsx("div",{className:"tx-list",children:s.transactions.map(n=>{var m;return e.jsxs("div",{className:"tx-row",children:[e.jsx("div",{className:"tx-icon",style:{background:n.type==="income"?"rgba(52,211,153,0.12)":"rgba(248,113,113,0.12)",color:n.type==="income"?"var(--success)":"var(--danger)"},children:n.type==="income"?e.jsx(ta,{size:14}):e.jsx(oe,{size:14})}),e.jsxs("div",{className:"tx-meta",children:[e.jsx("span",{className:"tx-desc",children:n.description||((m=n.categories)==null?void 0:m.name)||"Transaksi"}),e.jsx("span",{className:"tx-date",children:new Date(n.date).toLocaleDateString("id-ID",{day:"numeric",month:"short"})})]}),e.jsxs("span",{className:`tx-amount tabular ${n.type==="income"?"inc":"exp"}`,children:[n.type==="income"?"+":"−",p(n.amount)]})]},n.id)})})),ae==="budget"&&(f?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:[...Array(3)].map((n,m)=>e.jsx("div",{className:"skeleton",style:{height:44}},m))}):b?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:e.jsx(ea,{size:14})}),e.jsx("span",{children:"Tambahkan kategori dan budget"}),e.jsx(G,{to:`/categories?month=${l}`,className:"empty-hint-link",style:{color:"var(--accent)"},children:"Atur →"})]}):e.jsxs(e.Fragment,{children:[(i.length>0||c.length>0)&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"budget-section-label",children:"Hutang & Piutang"}),e.jsx("div",{className:"budget-rows",children:[...i,...c].map(n=>{const m=n.jenis==="piutang",z=m?"#f59e0b":"#f87171",h=new Date;h.setHours(0,0,0,0);const y=n.due_date?new Date(n.due_date):null,x=y?Math.round((y-h)/864e5):null,w=x!==null&&x<0;return e.jsxs("div",{className:"brow",children:[e.jsxs("div",{className:"brow-left",children:[e.jsx("span",{className:"brow-icon",style:{background:`${z}18`,color:z},children:m?e.jsx(sa,{size:13}):e.jsx(ie,{size:13})}),e.jsxs("div",{style:{minWidth:0},children:[e.jsx("span",{className:"brow-name",children:n.nama}),e.jsx("span",{style:{fontSize:"0.62rem",color:"var(--text-muted)",marginLeft:6},children:m?"piutang":"hutang"}),w&&e.jsx("span",{className:"badge badge-danger",style:{fontSize:"0.6rem",padding:"2px 6px",marginLeft:6},children:"Terlambat"})]})]}),e.jsx("div",{style:{flex:1}}),e.jsxs("div",{className:"brow-right",children:[e.jsx("span",{className:"brow-spent tabular",style:{color:z},children:p(n.amount)}),n.due_date&&e.jsx("span",{className:"brow-limit tabular",style:{color:w?"var(--danger)":x<=7?"var(--warning)":"var(--text-muted)"},children:x===0?"Hari ini":x>0?`${x}h lagi`:`${Math.abs(x)}h lalu`})]})]},n.id)})})]}),(i.length>0||c.length>0)&&a.length>0&&e.jsx("div",{style:{height:1,background:"var(--border)",margin:"12px 0"}}),a.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"budget-section-label",children:"Pengeluaran Rutin"}),e.jsx("div",{className:"budget-rows",children:a.map(n=>e.jsx(N,{cat:n},n.id))})]}),(a.length>0||i.length>0||c.length>0)&&t.length>0&&e.jsx("div",{style:{height:1,background:"var(--border)",margin:"12px 0"}}),t.length>0?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"budget-section-label",children:"Kategori Lainnya"}),e.jsx("div",{className:"budget-rows",children:t.map(n=>e.jsx(N,{cat:n},n.id))})]}):i.length===0&&c.length===0&&a.length===0&&e.jsxs("div",{style:{fontSize:"0.72rem",color:"var(--text-muted)"},children:["Belum ada kategori dengan budget. ",e.jsx(G,{to:`/categories?month=${l}`,style:{color:"var(--accent)"},children:"Atur →"})]})]}))]})]})]})})()]}),ba&&(()=>{const a=s.salary>0,t=async()=>{const i=parseFloat(T.amount.replace(/\D/g,""))||0;if(i){Se(!0);try{const c=T.date||`${l}-01`;if(s.gajiTx){const{error:b}=await u.from("transactions").update({amount:i,description:T.note,date:c}).eq("id",s.gajiTx.id);if(b)throw b}else{const{error:b}=await u.from("transactions").insert({user_id:d.id,category_id:s.gajiCatId,type:"income",amount:i,description:T.note,date:c});if(b)throw b}v("Pemasukan disimpan","success"),Q(!1),H()}catch(c){v(c.message,"error")}finally{Se(!1)}}};return e.jsx("div",{className:"modal-overlay",onClick:()=>Q(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:380},onClick:i=>i.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"modal-title",children:["Pemasukan Bulanan ",S(l)]}),e.jsx("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:a?"Edit jumlah atau catatan":"Catat pemasukan bulan ini"})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>Q(!1),children:e.jsx(I,{size:16})})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Jumlah Pemasukan"}),e.jsx(ra,{value:T.amount,onChange:i=>ee(c=>({...c,amount:i})),autoFocus:!0})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Tanggal Diterima"}),e.jsx("input",{className:"form-input",type:"date",value:T.date,min:`${l}-01`,max:(()=>{const[i,c]=l.split("-").map(Number);return new Date(i,c,0).toISOString().split("T")[0]})(),onChange:i=>ee(c=>({...c,date:i.target.value}))})]}),e.jsxs("div",{className:"form-group",children:[e.jsxs("label",{className:"form-label",children:["Catatan ",!a&&e.jsx("span",{style:{color:"var(--text-muted)",fontWeight:400},children:"(opsional)"})]}),e.jsx("textarea",{className:"form-input",rows:2,placeholder:"Misal: gaji pokok + bonus, tunjangan, dll...",value:T.note,onChange:i=>ee(c=>({...c,note:i.target.value})),style:{resize:"vertical",fontFamily:"var(--font-sans)",fontSize:"0.875rem"}})]}),e.jsxs("div",{className:"flex gap-8 mt-16",children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>Q(!1),children:"Batal"}),e.jsx("button",{className:"btn btn-primary",style:{flex:1},onClick:t,disabled:_e||!T.amount,children:_e?"Menyimpan...":"Simpan"})]})]})})})(),ga&&e.jsx("div",{className:"modal-overlay",onClick:()=>ge(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:400},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Total Tabungan"}),e.jsxs("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:["Akumulasi s/d ",S(l)]})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>ge(!1),children:e.jsx(I,{size:16})})]}),e.jsxs("div",{className:"wajib-rows",children:[(d.tabungan_awal||0)>0&&e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:"rgba(52,211,153,0.12)",color:"var(--success)",fontSize:"0.55rem",fontWeight:800},children:"AWAL"}),e.jsxs("div",{children:[e.jsx("div",{className:"brow-name",children:"Saldo Awal Tabungan"}),e.jsx("div",{style:{fontSize:"0.65rem",color:"var(--text-muted)"},children:"sebelum mulai record"})]})]}),e.jsx("span",{className:"wajib-amount tabular",style:{color:"var(--success)"},children:p(d.tabungan_awal)})]}),s.tabunganPerMonth.length===0&&!(d.tabungan_awal>0)?e.jsx("div",{style:{fontSize:"0.75rem",color:"var(--text-muted)",padding:"8px 0"},children:'Belum ada alokasi tabungan. Set budget kategori "Tabungan Bulanan".'}):s.tabunganPerMonth.map(a=>e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:"rgba(52,211,153,0.12)",color:"var(--success)"},children:e.jsx(oe,{size:13})}),e.jsxs("div",{children:[e.jsx("div",{className:"brow-name",children:S(a.month)}),e.jsx("div",{style:{fontSize:"0.65rem",color:"var(--text-muted)"},children:"Tabungan Bulanan"})]})]}),e.jsxs("span",{className:"wajib-amount tabular",style:{color:Number(a.budget_limit)>0?"var(--success)":"var(--text-muted)"},children:["+",p(a.budget_limit)]})]},a.month)),s.hutangTabunganList.filter(a=>!a.lunas).length>0&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"wajib-divider",style:{margin:"8px 0"}}),e.jsx("div",{style:{fontSize:"0.62rem",fontWeight:700,textTransform:"uppercase",letterSpacing:"0.06em",color:"var(--text-muted)",marginBottom:4},children:"Outstanding bulan ini"}),s.hutangTabunganList.filter(a=>!a.lunas).map(a=>e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:a.jenis==="piutang"?"rgba(245,158,11,0.1)":"rgba(248,113,113,0.1)",color:a.jenis==="piutang"?"var(--warning)":"var(--danger)",fontSize:"0.9rem"},children:a.jenis==="piutang"?e.jsx(sa,{size:13}):e.jsx(ie,{size:13})}),e.jsxs("div",{children:[e.jsx("div",{className:"brow-name",children:a.nama}),e.jsx("div",{style:{fontSize:"0.62rem",color:"var(--text-muted)"},children:a.jenis==="hutang"?"Hutang":"Piutang"})]})]}),e.jsxs("span",{className:"wajib-amount tabular",style:{color:"var(--danger)"},children:["−",p(a.amount)]})]},a.id))]}),e.jsx("div",{className:"wajib-divider",style:{margin:"10px 0"}}),e.jsxs("div",{className:"wajib-row",style:{paddingTop:4},children:[e.jsx("span",{style:{fontSize:"0.78rem",fontWeight:700,color:"var(--text-primary)"},children:"Total Tabungan"}),e.jsx("span",{className:"wajib-amount tabular",style:{color:s.totalTabungan>0?"var(--success)":"var(--text-muted)",fontWeight:800},children:p(s.totalTabungan)})]})]})]})}),pa&&e.jsx("div",{className:"modal-overlay",onClick:()=>q(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:400},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Rencana Bulan Depan"}),e.jsx("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:S(de(l))})]}),e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsx(G,{to:"/savings",className:"btn btn-ghost btn-sm",style:{fontSize:"0.72rem"},onClick:()=>q(!1),children:"Kelola →"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>q(!1),children:e.jsx(I,{size:16})})]})]}),s.nextMonthPlans.length===0?e.jsxs("div",{className:"empty-hint",children:[e.jsx("span",{className:"empty-hint-icon",children:e.jsx(ie,{size:13})}),e.jsxs("span",{children:["Belum ada rencana untuk ",S(de(l)),"."]}),e.jsx(G,{to:"/savings",className:"empty-hint-link",onClick:()=>q(!1),children:"Tambah →"})]}):e.jsxs("div",{className:"wajib-rows",children:[s.nextMonthPlans.map(a=>e.jsxs("div",{className:"wajib-row",children:[e.jsx("span",{className:"brow-name",children:a.name}),e.jsx("span",{className:"wajib-amount tabular",children:p(a.amount)})]},a.id)),e.jsx("div",{className:"wajib-divider"}),e.jsxs("div",{className:"wajib-row",style:{paddingTop:10},children:[e.jsx("span",{style:{fontSize:"0.78rem",fontWeight:700,color:"var(--text-primary)"},children:"Total"}),e.jsx("span",{className:"wajib-amount tabular",children:p(s.nextMonthPlans.reduce((a,t)=>a+Number(t.amount),0))})]})]})]})}),ma&&e.jsx("div",{className:"modal-overlay",onClick:()=>Z(!1),children:e.jsxs("div",{className:"modal",style:{maxWidth:420},onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Pengeluaran Tetap"}),e.jsx("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:S(l)})]}),e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsx("button",{className:"btn btn-ghost btn-sm",style:{fontSize:"0.72rem"},onClick:()=>{Z(!1),ce(!0)},children:"Kelola"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>Z(!1),children:e.jsx(I,{size:16})})]})]}),e.jsxs("div",{className:"wajib-rows",children:[s.categories.filter(a=>Y(a)).map(a=>{const t=Number(a.budget_limit||0),i=s.salary>0&&t>0?Math.round(t/s.salary*100):null;return e.jsxs("div",{className:"wajib-row",children:[e.jsxs("div",{className:"wajib-left",children:[e.jsx("span",{className:"brow-icon",style:{background:"rgba(248,113,113,0.12)",color:"var(--danger)"},children:e.jsx(oe,{size:13})}),e.jsx("span",{className:"brow-name",children:a.name})]}),e.jsxs("div",{className:"wajib-right",children:[i&&e.jsxs("span",{className:"wajib-pct",children:[i,"%"]}),e.jsx("span",{className:"wajib-amount tabular",children:t>0?p(t):"—"})]})]},a.id)}),e.jsx("div",{className:"wajib-divider"}),e.jsxs("div",{className:"wajib-row",style:{paddingTop:10},children:[e.jsx("span",{style:{fontSize:"0.78rem",fontWeight:700,color:"var(--text-primary)"},children:"Total Potongan"}),e.jsxs("span",{className:"wajib-amount tabular",style:{color:"var(--danger)"},children:["−",p(Ie)]})]})]})]})}),la&&e.jsx("div",{className:"modal-overlay",onClick:()=>W(!1),children:e.jsxs("div",{className:"modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h2",{className:"modal-title",children:"Tambah Transaksi"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>W(!1),children:e.jsx(I,{size:16})})]}),e.jsx(Aa,{month:l,onSuccess:()=>{H(),W(!1)},onClose:()=>W(!1)})]})}),da&&!j&&!ze&&e.jsx("div",{className:"modal-overlay",onClick:()=>ce(!1),children:e.jsxs("div",{className:"modal cat-manager-modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"modal-title",children:"Kelola Kategori"}),e.jsx("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:S(l)})]}),e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[e.jsxs("button",{className:"btn btn-primary btn-sm",onClick:()=>{ca({is_mandatory:!0}),U(!0)},children:[e.jsx(aa,{size:13})," Kategori"]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>ce(!1),children:e.jsx(I,{size:16})})]})]}),e.jsxs("div",{style:{marginBottom:20},children:[e.jsx("p",{className:"cat-mgr-section-title",children:"Pengeluaran Wajib"}),e.jsx("div",{style:{display:"flex",flexDirection:"column"},children:s.categories.filter(a=>Y(a)).map(a=>{const t=Number(a.budget_limit)||0,i=s.salary>0&&t>0?Math.round(t/s.salary*100):null;return e.jsxs("div",{className:"cat-mgr-row",children:[e.jsxs("div",{className:"cat-mgr-left",children:[e.jsx("span",{className:"cat-mgr-icon",style:{background:"rgba(248,113,113,0.12)",color:"var(--danger)"},children:e.jsx(oe,{size:14})}),e.jsxs("div",{children:[e.jsx("span",{className:"cat-mgr-name",children:a.name}),e.jsx("span",{className:"cat-mgr-sub",children:"Wajib · langsung dipotong"})]})]}),e.jsxs("div",{className:"cat-mgr-right",children:[i&&e.jsxs("span",{className:"cat-mgr-pct",children:[i,"%"]}),e.jsx("span",{className:"cat-mgr-amount tabular",children:t>0?p(t):"—"}),e.jsx("button",{className:"btn btn-ghost btn-sm",style:{fontSize:"0.7rem"},onClick:()=>xa(a),children:"Ubah"})]})]},a.id)})})]})]})}),j&&(()=>{const a=s.categories.find(t=>t.id===j.id);return e.jsx("div",{className:"modal-overlay",onClick:()=>C(null),children:e.jsxs("div",{className:"modal",style:{maxWidth:380},onClick:t=>t.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"modal-title",children:["Pengeluaran Wajib — ",a==null?void 0:a.name]}),e.jsxs("p",{style:{fontSize:"0.72rem",color:"var(--text-muted)",marginTop:2},children:[S(l),s.salary>0?` · ${p(s.salary)}`:""]})]}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>C(null),children:e.jsx(I,{size:16})})]}),s.salary>0&&e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Persentase dari gaji"}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[e.jsxs("div",{style:{position:"relative",flex:1},children:[e.jsx("input",{className:"form-input",type:"number",placeholder:String(Wa),value:j.pct,onChange:t=>Be(t.target.value),min:"0",max:"100",step:"0.5",style:{paddingRight:36}}),e.jsx("span",{style:{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",color:"var(--text-muted)",fontWeight:700,fontSize:"0.85rem"},children:"%"})]}),j.pct&&s.salary>0&&e.jsxs("span",{style:{fontSize:"0.78rem",color:"var(--text-secondary)",fontWeight:600,whiteSpace:"nowrap"},children:["= ",p(Math.round(parseFloat(j.pct)/100*s.salary))]})]}),!j.pct&&e.jsx("div",{style:{display:"flex",gap:6,marginTop:6,flexWrap:"wrap"},children:[10,15,20,25].map(t=>e.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>Be(String(t)),children:[t,"%"]},t))})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Atau nominal langsung"}),e.jsx(ra,{value:j.nominal,onChange:fa,autoFocus:!s.salary})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:16},children:[e.jsx("button",{className:"btn btn-ghost btn-sm",style:{color:"var(--danger)",fontSize:"0.78rem"},onClick:()=>{C(null),me({id:a.id,name:a.name})},children:"Hapus Kategori"}),e.jsxs("div",{className:"flex gap-8",children:[e.jsx("button",{className:"btn btn-secondary",onClick:()=>C(null),children:"Batal"}),e.jsx("button",{className:"btn btn-primary",onClick:va,children:"Simpan"})]})]})]})})})(),J&&e.jsx(La,{title:"Hapus Kategori",message:`Hapus kategori "${J.name}"? Semua transaksi kategori ini juga akan terhapus.`,confirmLabel:"Hapus",onConfirm:ja,onCancel:()=>me(null)}),ze&&e.jsx("div",{className:"modal-overlay",onClick:()=>U(!1),children:e.jsxs("div",{className:"modal",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("h2",{className:"modal-title",children:V!=null&&V.id?"Edit Kategori":"Kategori Baru"}),e.jsx("button",{className:"btn btn-ghost",onClick:()=>U(!1),children:e.jsx(I,{size:16})})]}),e.jsx(Da,{editData:V,salary:s.salary,month:l,onSuccess:()=>{H(),U(!1)},onClose:()=>U(!1)})]})}),e.jsx("style",{children:`
        /* ── Month Picker Popup ───────────────── */
